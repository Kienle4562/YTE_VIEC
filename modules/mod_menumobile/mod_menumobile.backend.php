<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") ); 
    ...
    include_once("mod_menumobile.handler.php");
                ...
                <div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-sections">
                            Modules » <small>[menumobile] » Chỉnh sửa module</small>
                        </div>
                ...
                <div id="element-box">
                    ...
                    <div class="m">
                        ...
                        <form method="post" name="phpForm">
                                    ...
                                    <table class="admintable" width="100%">
                                        <tbody id="phone_container">
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="menumobile_type_id">
                                                        <option value="0">--Chọn menumobile để hiển thị--</option>
                                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="editlinktip hasTip" title="Cấp độ tối đa::+ Nhập vào 0 nếu bạn muốn hiển thị tất cả các menumobile con.<br />+ Nếu nhập vào số lớn hơn 0 thì những menumobile con có cấp độ nhỏ hơn hoặc bằng giá trị này sẽ hiển thị.">
                            ...
                            <div class="clr"></div>            
                            <input type="hidden" name="hidden" value="submit_mod_menumobile" />
