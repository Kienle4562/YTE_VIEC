...
<?php
	if (!(isset($_GET['view']) && $_GET['view'] == 'item_menu' && isset($_GET['task']) && ($_GET['task'] == 'news.choose2' ||$_GET['task'] == 'news.choose' || $_GET['task'] == 'product.choose' || $_GET['task'] == 'product.choose2'))) {
    ...
    switch (trim($_GET["view"])) {
		...
		case "item_menu":
			...
			switch (trim($_GET["task"])) {
				...
				case "news.choose2":
                    include_once("process/com_menu_item_menu.news.choose.process.php");
                    include_once("item_menu/com_menu.item_menu.news.choose2.php");
                break;
				...
				case "product.choose2":
					include_once("process/com_menu_item_menu.product.choose.process.php");
					include_once("item_menu/com_menu.item_menu.product.choose2.php");
				break;
