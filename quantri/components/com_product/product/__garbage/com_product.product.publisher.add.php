...
Nhà xuất bản: <small><small>[ Thêm mới ]</small></small><br>
		...
		<div>
			<fieldset class="adminform">
				...
				<tr>
					...
					<td colspan="2">
						<input class="text_area" name="publisher" id="publisher" value="" size="50" maxlength="255" title="nhà xuất bản" type="text">
					</td>
				</tr>
				<tr>
					<td class="key">
		...
		<input type="hidden" name="hidden" value="submit_com_publisher_add" />
