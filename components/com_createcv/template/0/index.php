...
<head>
	<?php
		include_once("components/com_createcv/template/0/css/app.php");
		include_once("components/com_createcv/template/0/css/cv.php");
		include_once("components/com_createcv/template/0/css/print.php");
		include_once("components/com_createcv/template/0/css/reset.php");
		include_once("components/com_createcv/template/0/css/style.php");
		...
		if($_SESSION["career"]["career_id"] != NULL)
		{
                                ...
                                <div id="group-top">
                                    <div id="cvo-profile" class="cvo-block">
                                        <div class="contact-item">
                                            ...
                                            <span id="cvo-profile-dob"> <?php echo date("d/m/Y", strtotime($row['birthday'])) ?> </span>
                                        </div>
                                        <div class="contact-item">
                                        ...
                                        <div class="contact-item">
                                            ...
                                            <span id="cvo-profile-email"><?php echo $row['email'] ?></span>
                                        </div>
                                        <div class="contact-item">
...
- Cấp bậc mong muốn: <?php echo $row['capbacmongmuon'] ?> <br />- Mức lương: <?php echo $row['mucluong'] ?><br />- Hình thức làm việc: <?php echo $row['hinhthuclamviec'] ?> <br />- Nơi làm việc mong muốn: <?php echo $row['noilamviecmongmuon'] ?> <br />
                            ...
                            <div id="group-right">
                                    ...
                                    <div id="education-table" class="cvo-block-body">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="cvo-education-time">
                                                (<span class="cvo-education-start"> <?php echo $bangcap1[$num_] ?></span> -  <span class="cvo-education-end"><?php echo $truongkhoahoc[$num_] ?></span>)
                                            </div>
								...
								<div id="cvo-experience" class="cvo-block">
                                    <div class="cvo-block-header">
                                        <span id="cvo-experience-blocktitle"> KỶ NĂNG & THÀNH TÍCH NỔI BẬT</span>
                                    </div>
                                    <div id="experience-table" class="cvo-block-body">
