<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    */
    ...
    switch(@$_REQUEST["act"]){
		...
		case "LoadList";
			$column = "fullname,diachi,";
			$column .= "career_id,career_id as action_id";
			if($_SESSION["session"]['Id'] !=4)
			{
				$where ='AND user_id ='.$_SESSION["session"]['Id'];
			}
			echo $core_class->getValueFromTableToJSON($db_name, $column,$where);
		break;
