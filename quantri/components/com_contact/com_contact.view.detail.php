        ...
        <div class="com_cart com_cart_order">
            ...
            <table class="user_information" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="col_2"><?php echo $row['customer_name']; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="col_2"><?php echo $row['delivery_address']; ?></td>
                </tr>
                <tr>
                    <td class="col_1">Thông tin khác</td>
                    <td class="col_2"><?php echo $row['note']; ?></td>
                </tr>
            </table>
                    ...
                    <?php
                        ...
                        while ($row_detail = $result->fetch(PDO::FETCH_ASSOC))
                        {
                            ...
                            <tr>
                                ...
                                <td class="col_2"><?php echo $row_detail['product_name']; ?></td>
