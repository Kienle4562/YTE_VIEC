    ...
    <tbody>
        ...
        <tr>
            <td style="padding: 0 35px;" class="prefooter-subheader" align="left">
                ...
                <div style="color: #7087A3">Website: https://yteviec.com/lien-he.html</div> 
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                                    <td>
                                                        <a style="display: block;text-decoration: none;color: #7087A3;" href="https://yteviec.com/lien-he.html">Liên hệ</a>
                                                    </td>
                                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                                    <td>
                                                        <a style="display: block;text-decoration: none;color: #7087A3;" href="https://yteviec.com/lien-he.html">Cẩm nang</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
