...
<div class="sitemap-container container m_bottom_20 pv-profile-section-body">
    <div class="clearfix m_xs_bottom_10">
		<div class="bg_white p_15 r_corners m_bottom_20">
			<h1 class="sitemap-header text-primary color_green">UPLOAD NHANH HỒ SƠ</h1>
        	<div id="showResult" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 f_none">
				<form autocomplete="off" class="awe-check" name="formResume" method="post" id="formResume">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							<input  required type="text" class="form-control" name="lastname" maxlength="100">
							<p class="has-error"></p>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							<input value="" required type="date"  style="background: #FFF" class="form-control date_month" name="birthday">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input value="" required type="number" class="form-control" name="mobile" id="mobile">
							<p class="has-error"></p>
						</div>
					</div>
					<div class="row">
					...
					<div style="display:none" class="row">
						...
						<div class="col-xs-12 col-sm-9 datebox">
							<input value="" type="text" class="form-control" name="tieudehoso1" maxlength='100'>
							<p class="has-error"></p>
						</div>
					</div>
					<!--<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-9">
							<input value="" type="text" class="form-control" name="capbacmongmuon" maxlength="50">
							<p class="has-error"></p>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-9 htlv">
							...
							<input style="display:none" required value="" type="text" name="hinhthuclamviec">
							<p class="has-error"></p>
						</div>
					</div>
					<div style="display:none" class="row">
				...
				<div class="education">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-9">
							<input value="" required type="text" class="form-control" name="truongkhoahoc[]" maxlength="50">
							<p class="has-error"></p>
						</div>
					</div>
...
, function(){
	...
	if ((Date.parse(fromDateBangCapYear) >= Date.parse(toDateBangCapYear))) {
        alert("Năm học kết thúc lớn hơn bắt đầu ");
