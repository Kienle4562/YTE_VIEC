<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") );
   ...
   $lang_text = $core_class->load_module_language('com_product_category_view', $GLOBALS['LANG']);
    ...
    /* get total row */
    $totalrow = $categoryProc->get_category_count_hot($cat_id);
    ...
    if ( $totalrow > 0 )
    {
        ...
        /* Get category items */
        $result = $categoryProc->get_category_hot($cat_id, intval($pager->offset), intval($pager->limit) ); ?>
		...
		?>
        	<div class="shop_isotope_item d_xs_inline_b">
                                    ...
                                    <figcaption>
											...
											<p><?php if($row['price']==0){ echo 'Giá liên hệ';}else{echo number_format($row['price'], 0) . ' VNĐ';}?></p>
