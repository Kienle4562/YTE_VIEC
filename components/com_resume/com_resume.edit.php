<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") );
	...
	if(!empty($_SESSION["career"]["career_id"]) && $_SESSION["career"]["career_id"] !=NULL){
		...
		if($myprocess->checkProfile($_REQUEST["id"], $_SESSION["career"]["career_id"])){

			//echo $_REQUEST["id"];

			$result = $myprocess->getThongTinCaNhan($_REQUEST["id"]);
...
<div class="sitemap-container container m_bottom_20 pv-profile-section-body">
    ...
    <div class="clearfix m_xs_bottom_10">
		...
		<div class="bg_white p_15 r_corners m_bottom_20">
			...
			<h1 class="sitemap-header text-primary color_green">CHỈNH SỬA HỒ SƠ</h1>

        	<div id="showResult" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 f_none">

				<form autocomplete="off" class="awe-check" name="formEditResume" method="post" id="formEditResume">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							...
							<label class="fileContainer fromcomputer" style="margin-top: 10px;">
								...
								<input type="file" value="" class="file" id="attach_file" onchange="return ajaxOnlyFile(this);" style="cursor: pointer; display: block; opacity: 0; position: absolute; right: 0px; text-align: right; top: -5px; height: auto; border-width: 0px 0px 10px 200px;">

								<p style="margin: 0px" class="has-error"></p>

								<input type="hidden" value="<?php echo $row['fileresume'] ?>" name="fileresume">

							</label>

							<span id="upload_text1"><?php echo $row['fileresume'] ?></span>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input value="<?php echo $row['tenprofilecv'] ?>" required type="text" class="form-control" name="tieudehoso" maxlength='100'>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							...
							<input value="<?php echo $row['lastname'] ?>" required type="text" class="form-control" name="lastname" maxlength="100">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input value="<?php echo $row['birthday'] ?>" required type="date"  style="background: #FFF" class="form-control date_month" name="birthday">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input type="email" name="email" class="form-control" disabled="disabled" value="<?php echo $_SESSION['career']['email'] ?>">
					...
					<div style="display:none" class="row">
						...
						<div class="col-xs-12 col-sm-9 datebox">
							...
							<input value="<?php echo $row['tieudehoso'] ?>" type="text" class="form-control" name="tieudehoso1" maxlength='100'>
				...
				?>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6">
							...
							<input type="text" class="form-control formatnumber" id="levelFrom_"  value="<?php echo $row['mucluong'] ?>" placeholder=" nhập mức lương" name="mucluong" maxlength="10">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<select required class="form-control" id="noilamviecmongmuon" name="noilamviecmongmuon">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<input <?php echo $row['not_experence'] == "1" ? "readonly" : "" ?> value="<?php echo $row['kinhnghiem'] ?>" required type="number" class="form-control" name="kinhnghiem" max="30">
				...
				<div class="education">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-5">
							...
							<?php echo $core_class->createSelectBoxWithArray($arrayListBC1, "bangcap[]", "required", $bangcap1[$num_]); ?>
					...
					<div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
								...
								<input type="hidden" name="profilecv_id" value="<?php echo $_REQUEST['id'] ?>" />
...
$("#editCV").click(function(){
    ...
    var frm = $("form[name=formEditResume]");
