					...
					<div>
						<fieldset class="adminform">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input  size="50" type="text" id="image_file" name="image_file[]" value="<?php echo $row['image'] ?>">
							...
							<tr>
								...
								<td colspan="2">
									...
									<select name="display_type">
										<?php
											$display_type = array("category"=>"Danh sách sản phẩm (hiển thị sản phẩm)","session"=>"Danh sách sản phẩm (hiển thị danh mục");											
											foreach($display_type as $key=>$value){ ?>
												<option <?php if($key == $row['display_type']){ echo "selected"; } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
										<?php } ?>
									</select>
								</td>
							</tr>
