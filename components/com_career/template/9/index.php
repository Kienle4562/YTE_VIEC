...
<head>
   <meta charset="utf8">
    <?php
		include_once("components/com_career/template/9/css/app.php");
		include_once("components/com_career/template/9/css/viewCV.php");
		include_once("components/com_career/template/9/css/print.php");
                            ...
                            <div class="height-curent">
                                <div id="cv-top" data-x-name="item" data-x-id="info">
                                    ...
                                    <div class="box-contact" data-x-id="info" data-x-name="item">
                                        ...
                                        <p class="icoweb" data-x-name="email"><i class="fa fa-envelope-square"></i><span data-x-id="email" contenteditable="true"><?php echo $row['email'] ?></span></p>
                                        ...
                                        <div data-x-name="list-item">
												...
												<div class="cv-box-content" data-x-name="sub-item">
													<h3>
														...
														<span class="exp-date"><em data-x-id="start" contenteditable="true"><?php echo $bangcap1[$num_] ?> </span>
													</h3>
													<p class="h3">
														<span data-x-id="cat" contenteditable="true"><?php echo $motachitiet[$num_] ?></span>
													</p>
													<div class="exp-content" contenteditable="true" data-x-id="des">Bằng cấp: <?php echo $bangcap1[$num_] ?><?php if(!empty($bangcap2[$num_])){ ?>(<?php echo $bangcap2[$num_] ?>) <?php } ?></div>
												</div>
											<?php }?>
                                        </div>
                                    </div>
