                    ...
                    <div class="m">
                        ...
                        <script language="javascript" type="text/javascript">
                            ...
                            function addTabs()
                            {
                                ...
                                CKEDITOR.replace('html_tab_' + tabCount, {height : '200px', toolbar : 'Full'});
                                tabCount++;
                            }
                                            ...
                                            <table class="admintable" width="100%">
                                                <tbody><tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <textarea class="text_area" name="keyword" id="keyword" cols="60" rows="5"><?php echo $keyword; ?></textarea>
                                                        </td>
                                                    </tr>				
                                                    <tr>
                                                        <td class="key">
