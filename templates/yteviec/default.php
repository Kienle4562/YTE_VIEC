...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $index.$template_folder; ?>/css/home.css">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $core_class->latest_version($template_folder."/css/style.bundle.css") ?>">

	<link rel="stylesheet" type="text/css" href="<?php echo $core_class->latest_version($template_folder."/css/vendors.bundle.css") ?>">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								...
								<a class="clickable" rel="nofollow" onClick="globalRegistrationModal.showModal();">
									...
									<i class="fa fa-fw fa-lg fa-user"></i>Đăng Ký
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="animated fadeIn">
					...
					<h2 class="sitemap-header text-primary">ĐĂNG KÝ TÀI KHOẢN</h2>
...
<!-- insert Gravity -->
    ...
    <script type="text/javascript" src="<?php echo $index.$template_folder; ?>/js/mobile-detect.min.js"></script>

    <script type="text/javascript" src="<?php echo $index.$template_folder; ?>/js/bootstrap.3.3.2.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo $core_class->latest_version($template_folder."/js/ui.footer2.js"); ?>"></script>

    <script type="text/javascript" src="<?php echo $index.$template_folder; ?>/js/readmore.min.js"></script>

    <script type="text/javascript" src="<?php echo $index.$template_folder; ?>/js/jquery.jcarousel.min.js"></script>

    <script type="text/javascript" src="<?php echo $index.$template_folder; ?>/js/handlebars.js"></script>
