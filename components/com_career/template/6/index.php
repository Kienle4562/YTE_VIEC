...
<head>
	<?php
		include_once("components/com_career/template/6/css/app.php");
		include_once("components/com_career/template/6/css/cv.php");
		include_once("components/com_career/template/6/css/print.php");
		include_once("components/com_career/template/6/css/reset.php");
		include_once("components/com_career/template/6/css/style.php");
