<div id="content-box">
		<div class="border">
			...
			<div class="m">
				...
				<div class="header icon-48-sections">Sản phẩm » <small>Chủng loại » </small><small><small>Chỉnh sửa</small></small></div>
		...
		<div>
			...
			$result = $myProcess->getSession($_GET['id']);
			...
			if($row = $result->fetch())
			{
				...
				<tr>
					...
					<td colspan="2">
						<input class="text_area" name="title" id="title" value="<?php echo $Title ?>" size="50" maxlength="50" title="Tiêu đề cho thông tin của bạn" type="text">
					</td>
				</tr>
				<tr>
		...
		<input type="hidden" name="hidden" value="submit_com_product_session_edit" />
