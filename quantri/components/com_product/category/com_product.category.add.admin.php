...
Danh mục sản phẩm: <small><small>[ Thêm mới ]</small></small><br>
</div>
		...
		<div>
			<fieldset class="adminform">
                ...
                <tr>
					...
					<td colspan="2">
						<input name="type_p" id="type_p0" value="0" class="inputbox" type="radio" checked="checked">
		...
		<input type="hidden" name="hidden" value="submit_com_product_category_add" />
