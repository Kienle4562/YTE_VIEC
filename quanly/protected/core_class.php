<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    class core_class
    {
		...
		// hàm xóa tạm thời có điều kiện  áp dụng cho bảng công việc
		function Update_WhereTable($table, $where)
        {
			$dbObj = new classDb();
			$sql = "UPDATE {$table} SET trangthai = 0, DELETE_FLG = 1  WHERE {$where}";
			return $dbObj->SqlQueryInputResult($sql, array());
		}
