									...
									<div class="col-xl-10 offset-xl-1">
										<div class="m-form__section m-form__section--first">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-9 col-lg-9">
													<input type="number" maxlength="50" name="soluongcantuyen" value="<?php echo $row['soluongcantuyen'] ?>" class="form-control m-input" required>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-xl-3 col-lg-3 col-form-label">
										...
										<div class="m-separator m-separator--dashed m-separator--lg"></div>
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-9 col-lg-9">
													<input type="text" required name="dotuoi" value="<?php echo $row['dotuoi'] ?>" placeholder="VD: tuổi từ 19 đến 35" class="form-control m-input">
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">
