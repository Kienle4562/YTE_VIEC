                        ...
                        <div class="height-curent">
                           <div id="cv-top">
                              <div data-x-name="item" data-x-id="info">
                                 ...
                                 <h2><span contenteditable="true" data-x-id="job"><?php echo $row['bangcap1']?></span></h2>
                              </div>
                           </div>
                           <div data-x-name="group-item">
                              ...
                              <div class="cvo-block" data-x-name="item" data-x-id="edu">
                                 ...
                                 <div data-x-name="list-item">
                                    <div class="cv-box-content" data-x-name="sub-item">
                                       ...
                                       <p class="h3"><span data-x-id="cat" contenteditable="true"><?php if(!empty($row['bangcap'])){?>Chuyên ngành: <?php echo $row['bangcap'] ?> <?php } ?></span></p>
                                       <div class="exp-content" contenteditable="true" data-x-id="des">Bằng cấp:  <?php echo $row['bangcap1'] ?></div>
                                    </div>
                                 </div>
								  <?php } ?>
                              </div>
