									...
									<div class="col-xl-8 offset-xl-2">
										<div class="m-form__section m-form__section--first">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-9 col-lg-9">
													<textarea data-provide="markdown" class="form-control m-input" name="quyenloi"></textarea>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-xl-3 col-lg-3 col-form-label">
												...
												<div class="col-xl-9 col-lg-9">
													<input type="text" maxlength="50" name="soluongcantuyen" class="form-control m-input">
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-xl-3 col-lg-3 col-form-label">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-9 col-lg-9">
													<input type="text" name="mucluongtoithieu" class="form-control m-input">
												</div>
												<label class="col-xl-3 col-lg-3 col-form-label">
													Mức lương tối đa:
												</label>
												<div class="col-xl-9 col-lg-9">
													<input type="text" name="mucluongtoida" class="form-control m-input">
												</div>
											</div>
