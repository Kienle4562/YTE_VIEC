...
<div class="sitemap-container container m_bottom_20 pv-profile-section-body">
    ...
    <div class="clearfix m_xs_bottom_10">
		...
		<div class="bg_white p_15 r_corners m_bottom_20">
			...
			<h1 class="sitemap-header text-primary color_green"> <a href="view-cv.html" class="cls-green"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>  THÔNG TIN</h1>
        	...
        	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 f_none">
                ...
                <form autocomplete="off" class="awe-check" name="formCV" method="post" id="formCV">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							...
							<input value="" required type="text" style="text-transform:uppercase" class="form-control" name="lastname" maxlength="50" placeholder="Nhập đầy đủ họ và tên">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<!--<input value="" required type="date" data-date-format="mm/dd/yy"  style="background: #FFF" class="form-control date_month" name="birthday">-->

							<input type="text" required value="" name="birthday" id="ngay_sinh" placeholder="dd/mm/yy" class="form-control m-input datepicker">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input value="<?php echo $row['mobile'] ?>" required type="text" class="form-control" name="mobile" id="mobile" placeholder="Số điện thoại liên hệ">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 datebox">
							...
							<input value="<?php echo $row['diachi'] ?>" required type="text" class="form-control" name="diachi" id="diachi" maxlength='100' placeholder="Địa chỉ nơi ở hiện tại">
				...
				<div class="education">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-xs-12 col-sm-2">
							 ...
							 <?php echo $core_class->createSelectBoxMonth("Tháng", $row['fromDateBangCapMonth'] != "1" ? "required" : "", $arrDateStart[0], "fromDateBangCapMonth"); ?>	
							...
							<div class="col-xs-12 col-sm-3">
							    ...
							    <?php echo $core_class->createSelectBoxYear("Năm", $row['fromDateBangCapYear'] != "1" ? "required" : "", $arrDateStart[1], "fromDateBangCapYear"); ?>
							...
							<div class="col-xs-12 col-sm-2">
								...
								<?php echo $core_class->createSelectBoxMonth("Tháng", $row['toDateBangCapMonth'] != "1" ? "required" : "", $arrDateEnd[0], "toDateBangCapMonth"); ?>
							...
							<div style="padding-right: 0px;" class="col-xs-12 col-sm-3">
						  	  	 ...
						  	  	 <?php echo $core_class->createSelectBoxYear("Năm", $row['toDateBangCapYear'] != "1" ? "required" : "", $arrDateEnd[1], "toDateBangCapYear"); ?>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-9">
							...
							<input value="<?php echo $truongkhoahoc[$num_] ?>" required type="text" class="form-control" name="truongkhoahoc[]" maxlength="50" placeholder="Nơi học tập">
				...
				<div class="experienceSectionAppend">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-9">
							...
							<input value="<?php echo $vitrichucdanh[$num_] ?>" type="text" class="form-control" name="vitrichucdanh[]" maxlength="50" placeholder="Vị trí, chức danh khi làm việc">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-9">
							...
							<input value="<?php echo $congty[$num_] ?>" <?php echo $row['not_experence'] != "1" ? "required" : "" ?> 
								
								type="text" class="form-control" name="congty[]" maxlength="50" placeholder="Nơi làm việc">
					...
					<div class="row">
						...
						?>
							...
							<textarea maxlength="4000" rows="9" type="text" class="form-control" name="motacongviec[]" placeholder="Vui lòng nhập tối đa không quá 4.000 ký tự"><?php echo $motacongviec[$num_] ?></textarea>
				...
				<div class="row">
					...
					<div class="row">
						...
						<input value="<?php echo $row['capbacmongmuon'] ?>" type="text" class="form-control" name="capbacmongmuon" maxlength='100' placeholder="Vị trí hoặc chức danh mong muốn khi ứng tuyển">
				...
				?>
					...
					<div <?php if(empty($row['thanhtichnoibat'])){ ?>style="display:none"<?php }?> class="row thanh_tich_noi_bat">
						...
						<div class="col-xs-12 col-sm-12">
							...
							<textarea
								placeholder="Theo nghiên cứu, những CV có phần thành tích ấn tượng sẽ lọt vào vòng sau cao gấp 3 lần so với CV ít hoặc không liệt kê mục thành tích."
								onkeyup="countCharSkill(this)" rows="9" class="form-control" name="thanhtichnoibat" id="thanhtichnoibat"><?php  echo $thanhtichnoibat; ?></textarea>
						</div>
					...
					<div class="row">
						...
						<!-- <textarea onkeyup="countCharTarget(this)" rows="9" class="form-control" name="muctieunghenghiep" id="muctieunghenghiep"><?php echo $muctieunghenghiep ?></textarea> -->
							<textarea 
								placeholder="Một trong những vấn đề được nhà tuyển dụng quan tâm nhất khi phỏng vấn và đọc cv đó chính là phần mục tiêu nghề nghiệp. Họ thường xoáy sâu vào đây để đánh giá chuẩn ứng viên, chuẩn bị thật kỹ từ mục tiêu nghề nghiệp ngắn hạn đến mục tiêu nghề nghiệp dài hạn sẽ giúp CV trở nênấn tượng và chuyên nghiệp hơn. "
							 
							onkeyup="countCharTarget(this)" rows="9" class="form-control" name="muctieunghenghiep" id="muctieunghenghiep"><?php echo $muctieunghenghiep ?></textarea>
					...
					<div class="row">
                        ...
                        <div style="text-align:center" class="col-sm-12">
                            ...
                            <div class="form-group">
								...
								<input type="hidden" name="tenprofilecv" />
								...
								<input type="hidden" name="theme_id" value="<?php echo $_REQUEST['temp'] ?>" />

								<input type="hidden" class="kinh_nghiem_lv" name="kinh_nghiem_lv" value="0" />
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 f_none">
				...
				<div style="border:0px" class="tabmenulinks">
					...
					<div class="col-md-12">
						...
						<form id="formUpload" method="post">
							...
							<span class="red">*Chọn hình ảnh khi tạo hồ sơ</span>
				...
				<div  class="tabmenulinks">

					<ul>

						<li class="active">
							<p>
								<a class = "detailCV-heading">THÔNG TIN HƯỚNG DẪN
									<br>
									<span class = "detailCV-description">
									Tham khảo ngay các thông tin hữu ích trong quá trình tạo CV xin việc, giúp CV của bạn đúng chuẩn, ấn tượng, tăng khả năng trúng tuyển. 
									</span>
								</a>
							</p>
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#personalinfo-section" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-info-circle"></i>&nbsp;&nbsp;Thông tin cá nhân
								</a>
							</p>
							<div class="collapse" id="personalinfo-section">
								<div class="card card-body textCV-description">
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#education-section" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-address-card-o"></i>&nbsp;&nbsp;Học vấn và bằng cấp
								</a>
							</p>
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#experience-section" role="button" aria-expanded="false" aria-controls="collapseExample">
								<i class="fa fa-briefcase"></i>&nbsp;&nbsp;Kinh nghiệm làm việc
								</a>
							</p>
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#language-section" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-language"></i>&nbsp;&nbsp;Trình độ ngoại ngữ
								</a>
							</p>
							<div class="collapse" id="language-section">
								<div class="card card-body textCV-description ">
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#desired-job" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-chevron-circle-right"></i>&nbsp;&nbsp;Công việc mong muốn
								</a>
							</p>
							<div class="collapse" id="desired-job">
								<div class="card card-body textCV-description ">
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#award-section" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-trophy"></i>&nbsp;&nbsp;Kỹ năng và thành tích nổi bật
								</a>
							</p>
							<div class="collapse" id="award-section">
								<div class="card card-body textCV-description ">
								</div>
							</div>
						</li>
						...
						<li class="active">
							<p>
								<a class="detailCV-heading-child" data-toggle="collapse" href="#career-goals" role="button" aria-expanded="false" aria-controls="collapseExample">
									<i class="fa fa-flag"></i>&nbsp;&nbsp;Mục tiêu nghề nghiệp
								</a>
							</p>
							<div class="collapse" id="career-goals">
								<div class="card card-body textCV-description ">
...
function countCharSkill(val) {
	...
	if (len > max) {
		...
		var char = max - len;
		$('#charNumSkill').text('Còn lại ' + char +' ký tự');
	}
};
...
function countCharTarget(val) {
	...
	if (len > max) {
		swal({
		title: "Cảnh báo", text: "Vui lòng nhập tối đa không quá 2000 ký tự", type: "warning"},);
		val.value = val.value.substring(0, max);
	} else {
		var char = max - len;
		$('#charNumTarget').text('Còn lại ' + char +' ký tự');
	}
};
...
$("#createCV").click(function(){
    ...
    if($(frm)[0].checkValidity()) {
		...
		swal({
			title: "Thành công", text: "Tạo hồ sơ thành công", type: "success"},
			function(){ 
...
$("#levelFrom, #levelTo").change(function(){
...

	{
		...
		swal({
			title: "Thông tin lỗi", text: "Mức lương không phù hợp", type: "error"},
		);
...
, function(){
	...
	if ((Date.parse(rexp_yeah_start) >= Date.parse(rexp_year_end))) {
        ...
        alert("Thời gian làm việc chưa đúng");
...
$(document).on('click', '.hinhthuclamviec', function() {      

    $('.hinhthuclamviec').not(this).prop('checked', false);      
...
, function(){
    ...
    if ((Date.parse(fromDateBangCapYear) >= Date.parse(toDateBangCapYear))) {
		...
		swal({
			title: "Thông tin lỗi", text: "Năm học kết thúc phải lớn hơn năm bắt đầu", type: "error"},
		);
