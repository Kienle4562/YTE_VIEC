								...
								<div id="ZoneShowCVTemplate" class="cv-template-wrapper cv-template-4 fontCVRoboto clrBlackRed fontCVsize14">
									...
									<div class="col-xs-12 subCVpage">
										<div class="col-xs-5 left-col">
											...
											<div class="col-xs-12 content">
												<ul class="contact">
													...
													<li class="email"><i class="fa fa-envelope"></i><span><?php echo $row['email'] ?></span></li>
												</ul>
												<?php /* TẠM GỠ
												<h3>Kỹ năng</h3>
										...
										<div class="col-xs-7 right-col" id="full_height">
											<header>
												<h2 id="height" style="text-transform: uppercase;"><?php echo $row['firstname'] ?> <?php echo $row['lastname'] ?></h2>
												<h4><?php echo $row['tieudehoso'] ?></h4>
												<div class="bgtf"></div>
											</header>
											<div class="col-xs-12 content">
												...
												<div class="exp text-edt">
													<div class="title">
														...
														- Bằng cấp : <?php echo $bangcap1[$num_] ?><?php if(!empty($bangcap2[$num_])){ ?>(<?php echo $bangcap2[$num_] ?>) <?php } ?> <br>
