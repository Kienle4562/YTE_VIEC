<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") ); 
    ...
    include_once("mod_product_khachhangyeuthich.handler.php");
				...
				<script language="javascript" type="text/javascript">
					...
					function SetFileField( fileUrl, data )
					{
				        ...
				        <form method="post" name="phpForm">
                                    ...
                                    <table class="admintable" width="100%">
                                        <tbody id="phone_container">
                                        	<tr>
                                                ...
                                                <td>
                                                    <input class="inputbox" type="text" name="khung5_title" maxlength="255" value="<?= $params["khung5_title"] ?>" style="width:306px;"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="key" align="right">
                                                ...
                                                <td>
                                                    <input class="inputbox" type="text" id="khung5_image" name="khung5_image" maxlength="500" value="<?= $params["khung5_image"] ?>" style="width:306px;" />
                                                    <a title="Chọn hình ảnh"  href="javascript:void(0)" onClick="javascript:BrowseServer('khung5_image');">Lựa chọn</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="key" align="right">
                                                ...
                                                <td>
                                                    <input class="inputbox" type="text" name="khung5_link_url" id="khung5_link_url" readonly="readonly" maxlength="500" value="<?= $params["khung5_linkurl"] ?>" style="width:306px;" />
                                                </td>
                                            </tr>
                                        	<tr>
                                                <td class="key" align="right">
                                                ...
                                                <td>
                                                    <div>
                                                        <input checked="checked" id="khung5_rdoNewsCategories" type="radio" name="khung5_rdotype" value="rdoNewsCategories" onclick="javascript:return ChangeLink5(2);">
                                                        <label for="khung5_rdoNewsCategories">Danh mục tin tức</label>
                                                        <input id="khung5_rdoNewsArticle" type="radio" name="khung5_rdotype" value="rdoNewsArticle" onclick="javascript:return ChangeLink5(3);">
                                                        <label for="khung5_rdoNewsArticle">Liên kết bản tin</label>
                                                        <input id="khung5_rdoProductCategories" type="radio" name="khung5_rdotype" value="rdoProductCategories" onclick="javascript:return ChangeLink5(4);">
                                                        <label for="khung5_rdoProductCategories">Danh mục sản phẩm</label>
                                                        <div class="clear"></div>
                                                        <input id="khung5_rdoProductArticle" type="radio" name="khung5_rdotype" value="rdoProductDetail" onclick="javascript:return ChangeLink5(5);">
                                                        <label for="khung5_rdoProductArticle">Liên kết sản phẩm</label>
                                                        <input id="khung5_rdoExternal" type="radio" name="khung5_rdotype" value="rdoExternal" onclick="javascript:return ChangeLink5(1);">
                                                        <label for="khung5_rdoExternal">Trang ngoài</label>
                                                        <input onclick="setlink(this.id,'khung5')" id="khung5_rdoNull" type="radio" name="khung5_rdotype" value="rdoNull" onclick="javascript:return ChangeLink5(6);">
                                                        <label for="khung5_rdoNull">Không liên kết</label>
                                                        <div class="clear"></div>                                               
                                                        <input id="khung5_rdoContact" onclick="setlink(this.id,'khung5')" type="radio" name="khung5_rdotype" value="rdoContact" onclick="javascript:return ChangeLink5(8);">
                                                        <label for="khung5_rdoContact">Liên hệ</label>
                                                       
                                                        <input id="khung5_rdoProductCategories2" type="radio" name="khung5_rdotype" value="rdoProductCategories2" onclick="javascript:return ChangeLink5(9);"> <label for="khung5_rdoProductCategories2">Danh mục sản phẩm mới</label>
                                                    </div>
                                                                                                
                                                    <div id="khung5_news_category_page" style="min-height:150px;">
                                                        <select onchange="setlink(this.id,'khung5_link_url')" name="khung5_select_news_category_page" id="khung5_select_news_category_page" class="inputbox" size="10" style="width:306px;">
                                                            <option value="0"  selected="selected">Chọn danh mục</option>
                                                            <?php category(0); ?>
                                                        </select>
                                                    </div>
                                                    
                                                    <div id="khung5_news_article_page" style="min-height:150px;display:none;">
                                                        <div style="padding-top:20px;">
                                                            <div style="float: left;">
                                                                <input id="khung5_news_title" name="khung5_news_title" type="text" value="Chọn bản tin cần liên kết" readonly="true" size="50" />
                                                            </div>
                                                            <div class="button2-left">
                                                                <div class="blank">
                                                                    <a class="modal" title="Chọn một bài viết"  href="/quantri/?com=com_menu&view=item_menu&task=news.choose2&lang_code=vi&khung=khung5" rel="{handler: 'iframe', size: {x: 1000, y: 600}}">Lựa chọn</a>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" id="khung5_select_news_article_page" name="khung5_select_news_article_page" value="0" />
                                                            <input onChange="setlink(this.id,'khung5_link_url')" type="hidden" id="khung5_news_alias" name="khung5_news_alias" value="" />
                                                        </div>
                                                    </div>
                                                    
                                                    <div id="khung5_product_category_page" style="min-height:150px;display:none">
                                                        <select onchange="setlink(this.id,'khung5_link_url')" name="khung5_select_product_category_page" id="khung5_select_product_category_page" class="inputbox" size="10" style="width:306px;">
                                                            <option value="0"  selected="selected">Chọn danh mục</option>
                                                            <?php category_product(0); ?>
                                                        </select>
                                                    </div>
                                                    <div id="khung5_product_category_page_2" style="min-height:150px;display:none">
                                                        <select onchange="setlink(this.id,'khung5_link_url')" name="khung5_select_product_category_page_2" id="khung5_select_product_category_page_2" class="inputbox" size="10" style="width:306px;">
                                                            <option value="0"  selected="selected">Chọn danh mục</option>
                                                                <?php category_product_2(0); ?>
                                                        </select>
                                                    </div>
                                                    <div id="khung5_product_detail_page" style="min-height:150px;display:none">
                                                        <div style="padding-top:20px;">
                                                            <div style="float: left;">
                                                                <input id="khung5_product_title" name="khung5_product_title" type="text" value="Chọn sản phẩm cần liên kết" readonly="true" size="50" />
                                                            </div>
                                                            <div class="button2-left">
                                                                <div class="blank">
                                                                    <a class="modal" title="Chọn một sản phẩm"  href="/quantri/?com=com_menu&view=item_menu&task=product.choose2&lang_code=vi&khung=khung5" rel="{handler: 'iframe', size: {x: 1000, y: 600}}">Lựa chọn</a>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" id="khung5_select_product_page" name="khung5_select_product_page" value="0" />
                                                            <input type="hidden" id="khung5_product_alias" name="khung5_product_alias" value="" />
                                                        </div>
                                                    </div>
                                                    
                                                    <div id="khung5_external_page" style="min-height:150px;display:none">
                                                        <div style="padding-top:20px;">
                                                            <span style="font-weight:bold;">Nhập đường dẫn</span><br />
                                                            <input onkeyup="setlink(this.id,'khung5_link_url')" type="text" id="khung5_txt_url" name="khung5_txt_url" style="width:306px;" />
                                                        </div>
                                                    </div>
					        ...
					        <div class="clr"></div>			
					        <input type="hidden" name="hidden" value="submit_mod_product_khachhangyeuthich" />
