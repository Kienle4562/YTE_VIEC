...
<title>Kích Hoạt Tài Khoản Nhà Tuyển Dụng Tại Y Tế Việc</title>
                                        ...
                                        <tbody>
											<tr>
												<td style="color: #fefefe; font-weight: bold; font-family: Helvetica, Arial, sans-serif;">
													<h3>KÍCH HOẠT TÀI KHOẢN TẠI Y TẾ VIỆC</h3>
												</td>
											</tr>
                                        </tbody>
									</table>
                    ...
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
                        ...
                        <tr>
                            <td  class="main-subheader" style="color: #a4a4a4; font-size: 12px; font-weight: normal; line-height:20px; font-family: Helvetica, Arial, sans-serif;">
                                ...
                                Chúng tôi vừa nhận được thông tin đăng ký tài khoản của quý khách bằng Email này, hiện tại tài khoản của quý khách vẫn đang trong trạng thái chờ kích hoạt, quý khách vui lòng nhấn vào nút <b>Kích Hoạt</b> bên dưới để kích hoạt tài khoản của quý khách, sau khi kích hoạt tài khoản quý khách có thể truy cập vào hệ thống của Y Tế Việc.
						...
						<tr>
							<td>
								<a href="<?php echo $_SERVER['HTTP_HOST'] ?>?active=<?php echo $makichhoat ?>" style="background-color: #7087A3; font-size: 12px; padding: 10px 15px; color: #fff; text-decoration: none"> KÍCH HOẠT</a>
							</td>
						</tr>
                        </tbody></table>
                </td>
