<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    $result = $myprocess->process_getdetailinformation($_GET["id"]);
                ...
                <div id="toolbar-box">
                    ...
                    <div class="m">
                        ...
                        <div class="header icon-48-gallery">
                        	<?php $__mod = $myprocess->get_module_info($row['module_id'])->fetch(PDO::FETCH_ASSOC); ?>
                            Modules » <small>[Trình diễn ảnh] » <?php $core_class->create_lang_flag($__mod['lang_code'], 24); ?> <?php echo $__mod['title']; ?> » Chỉnh sửa ảnh</small>
                        </div>
                        <div class="clr"></div>
                    </div>
                    <div class="b">
                        ...
                        <form method="post" name="phpForm">
                            <div>
                                <fieldset class="adminform">
                                    ...
                                    <input type="hidden" name="gallery_id" value="<?php echo $row['module_id']; ?>">
                                    <table class="admintable">
                                        <tbody>
                                            <tr>
                                                <td class="key">
                                                    <label for="title">Hình ảnh:</label></td>
                                                <td colspan="2">
                                                    <div style="float: left;">
                                                        <input style="background: #ffffff;" type="text" id="image_file" name="image_file" value="<?php echo $row['image_file']; ?>" size="150" /> 
                                                    </div>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                    <input style="background: #ffffff;" type="text" id="logo_company" name="logo_company" value="<?php echo $row['logo_company'] ?>" size="150" /> 
                                                </div>
                                                <div class="button2-left">
                                                    <div class="blank">
										...
										<tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                    <input style="background: #ffffff;" type="text" id="title_name" name="title_name" value="<?php echo $row['title_name'] ?>" size="150" /> 
                                                </div>
                                            </td>
                                        </tr>
										<tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                   <textarea name="description" style=" min-width:600px; max-width:100%;min-height:50px;height:100%;width:100%;"><?php echo $row['description'] ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
										<tr>
											...
											<td colspan="2">
												<input style="background: #ffffff;" type="text" name="link" value="<?php echo $row['link']; ?>" size="150" />
												<br />
										...
										<tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                    <input style="background: #ffffff;" type="text" id="target" name="target" value="<?php echo $row['target'] ?>" size="150" /> 
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
										...
										<tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                    <input style="background: #ffffff;" type="text" id="price" name="price" value="<?php echo $row['price'] ?>" size="150" /> 
                                                </div>
                                            </td>
                                        </tr>
										<tr>
                                            ...
                                            <td colspan="2">
                                                <div style="float: left;">
                                                     <textarea name="contact_customer" style=" min-width:600px; max-width:100%;min-height:50px;height:100%;width:100%;"><?php echo $row['contact_customer'] ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                            <tr>
                            ...
                            <input type="hidden" name="hidden" value="submit_com_gallery_detail_edit" />
