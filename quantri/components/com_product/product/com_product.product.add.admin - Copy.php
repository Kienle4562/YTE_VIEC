                                        ...
                                        <table class="admintable" width="100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                       <input class="text_area" name="size" id="size" placeholder="size(37,38..) or loại size (XL ,L ,M)..." size="50" maxlength="255" title="nhập kích cở" type="text">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="key">
                                                    ...
                                                    <td colspan="2">
                                                      <input class="text_area" name="color" id="color" placeholder="Colour enter spaced . ex : blue , black, white,..." size="50" maxlength="255" title="Please enter color" type="text">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="key">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                     <input type="text" name="keyword" id="tags" value="" data-role="tagsinput" title="Tags bÃ i viáº¿t" />     
                                                    </td>
                                                </tr>                
                                                <tr>
                                                    <td class="key">
