...
#cvo-toolbar span.fontsize .fa,
#cvo-toolbar span.line-height .fa {
	line-height: 22px
}
...
#cvo-toolbar span.fontsize:nth-child(2),
#cvo-toolbar span.line-height:nth-child(2) {
	font-size: 14px
}
...
.btn-save-cv:hover {
	background-color: #0ba25e!important;
	color: #fff!important
}
.btn-topcv-primary {
	background-color: #0ba25e;
...
#save-done .jobs-container .job:hover {}#save-done .jobs-container .job .title {
	font-weight: 500;
	font-size: 14px;
	display: block;
	color: #444;
...
#save-done .jobs-container h2 {
	...
	font-weight: 500;
	color: #fff;
	background-image: url(../../images/header-pixel.png), linear-gradient(160deg, #0ba25e 10%, hsla(153, 95%, 34%, 0.88) 100%);
...
#save-done .jobs-container .topcv-loader,
#save-done .jobs-container .vlance-loader {
	position: relative;
	padding-top: 10px;
	top: 0;
	left: 50%;
...
#save-done .jobs-container .topcv-loader i,
#save-done .jobs-container .vlance-loader i {
	font-size: 36px;
	line-height: 80px
}
...
@media(min-width:768px){.footer-top .footer-col-left {
...
#header-viewer .btn-download-cv,
#header-viewer .btn-download-cv-private a,
#header-viewer .btn-download-cover-letter {
	float: right;
	background: 0 0;
	color: #ccc;
	padding: 16px 20px;
...
#header-viewer .btn-download-cv:hover,
#header-viewer .btn-download-cv-private:hover a,
#header-viewer .btn-download-cover-letter:hover {
	color: #fff
}
...
.btn-tvl {}.btn-tvl:hover {
	border-color: #0ba25e!important;
	background-color: #0ba25e
}
.btn-tvl a {
...
.viecngay-jobs-container {}.viecngay-jobs {
	overflow: hidden
}
.viecngay-loader {
	text-align: center;
