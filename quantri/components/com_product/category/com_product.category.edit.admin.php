             ...
             <script type="text/javascript" src="../myeditor/myfinder/ckfinder.js"></script>
				...
				<form method="post" name="phpForm">
					<div>
						...
						<td colspan="2">
						<input style="width:250px;" type="text" id="image_file" name="image_file" value="<?php echo $row['image'] ?>">
                            ...
                            <tr>
								...
								<td colspan="2">
									<?php if($row['type_category'] == 1){?>
									<input name="type_p" id="type_p0" value="0" class="inputbox" type="radio">
									<label for="enabled0">Quần,Áo,Đầm</label>
									<input name="type_p" id="type_p1" value="1" checked="checked" class="inputbox" type="radio">
									<label for="enabled1">Phụ kiện, Nước Hoa, Giầy dép</label>
									<?php } else {?>
									<input name="type_p" id="type_p0" value="0" checked="checked" class="inputbox" type="radio">
									<label for="enabled0">Quần,Áo,Đầm</label>
									<input name="type_p" id="type_p1" value="1" class="inputbox" type="radio">
									<label for="enabled1">Phụ kiện, Nước Hoa, Giầy dép</label>
									<?php }?>
								</td>
							</tr>
							<tr>
								...
								<td colspan="2">
									<?php // var_dump($_APP['config']['com_product']['display_type'][$row['alias']]); ?>
									<select name="display_type">
										<option value="-1">Theo cấu hình hệ thống</option>
										<?php
										
											if (isset($_APP['config']['com_product']['display_type'][$row['alias']])) {
												$display_type = $_APP['config']['com_product']['display_type'][$row['alias']];
											}
											...
											if ($display_type != null && $display_type == 1) {
												...
												echo '<option value="1">';
											} echo 'Danh sách sản phẩm (có phân theo nhóm)</option>';
										?>
									</select>
								</td>
							</tr>
				...
				<input type="hidden" name="hidden" value="submit_com_product_category_edit" />
