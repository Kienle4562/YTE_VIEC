<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") );
    ...
    class process_mod_congty extends modules_models
    {
        public function getData()
        {
			...
			trn_congty.DISORDER
			FROM
			trn_congty WHERE trn_congty.bvhangdau = 1 AND trn_congty.trangthai = 1 AND trn_congty.hien_thi = 1 ORDER BY trn_congty.pin DESC, trn_congty.DISORDER DESC LIMIT 6";
