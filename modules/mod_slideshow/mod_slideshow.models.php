<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") );
    ...
    class process_mod_slideshow extends modules_models
    {
		//Lấy loại menu
		...
		function getTinhThanh(){
		    $sql = "SELECT * FROM mst_tinhthanh WHERE id != 1 ORDER BY DISORDER DESC";
        ...
        function getChuyenKhoa($danhmucId){
		    $sql = "SELECT * FROM mst_chuyenkhoa WHERE danhmuccv_id = ? ORDER BY DISORDER";
