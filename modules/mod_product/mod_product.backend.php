<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") ); 
    ...
    include_once("mod_product.handler.php");

    $myprocess = new process_mod_product();
				...
				<script language="javascript" type="text/javascript">
...

					{
				        ...
				        <form method="post" name="phpForm">
                                ...
                                <fieldset class="adminform">
                                    ...
                                    <table class="admintable" width="100%">
                                        ...
                                        <tbody id="phone_container">
											...
											<tr>
                                                <td class="key">Banner product</td>
                                                <td>
													<input size="70" type="text" name="bannerproduct" id="bannerproduct" value="<?php echo $params['bannerproduct']; ?>" />
													<a title="Chọn hình ảnh"  href="javascript:void(0)" onClick="javascript:BrowseServer('bannerproduct');">Lựa chọn</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="key">Link banner</td>
                                                <td>
													<input size="70" type="text" name="linkbanner" id="linkbanner" value="<?php echo $params['linkbanner']; ?>" />
                                                </td>
                                            </tr>
                                        </tbody>
					        ...
					        <input type="hidden" name="hidden" value="submit_mod_product" />
