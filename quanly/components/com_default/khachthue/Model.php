<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    $com_name = "khachthue";
	$title = "KHÁCH THUÊ";
	$mota = "danh sách khách thuê";
	$db_name = "trn_khachthue";
	$primary_key = "khachthue_id";
    ...
    */
    ...
    switch(@$_REQUEST["act"]){
		...
		case "LoadList";
			$column = "hinhdaidien,tenkhachthue,sodienthoai,phongtro_id,daidienphong,";
			$column .= "khachthue_id,khachthue_id as action_id";
