<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") );
    ...
    include_once("mod_viecgoiy.models.php");
...
<section class="feature container home__jobs-you-will-love">
	...
	<div class="col-lg-12 col-xs-12">
		...
		<h1 class="text-center">Việc Làm Gợi Ý</h1>
		...
		<div class="tabs-container">
			...
			<div class="tab-content">
				...
				<?php /*<div class="tab-pane tab-job active" id="topJobs">
					...
					<div class="panel-content">
						...
						<div class="job-carousels">
							...
							<?php
								...
								$process_congviecgoiy = new process_congviecgoiy();

								$where = "WHERE (trn_congviec.hot_job = 1 OR trn_congviec.hot_job = 0) ";

								$where .= "AND trn_congviec.trangthai = 1 AND trn_congviec.DELETE_FLG = 0";

								$result = $process_congviecgoiy->getData($where);
							...
							<?php	if($number == 10 || $total == $result->rowCount()){ ?>
				...
				<div class="tab-pane tab-company active" id="recommendedJobs">
					...
					<div class="panel-content">
						...
						<div class="row">
							...
							<?php
								...
								$where = "WHERE (trn_congviec.mucluongtoithieu < 20000000 OR trn_congviec.mucluongtoithieu IS NULL)";
								...
								<div class="job row fix_box">
									...
									<div class="col-xs-10 col-content">
										...
										<a href="<?php echo $link ?>" target="_blank" title="<?php echo $row["tencongviec"]. " - " . $row["tencongty"]; ?>">
											...
											<p class="title text-clip job-title"><?php echo strtolower($row["tencongviec"]); ?></p>
