...
(function () {
        ...
        d.prototype = {
            ...
            disableFileContextMenuOption : function (f, g) {
                ...
                return function () {
                    for (var n = 0; n < k.length; n++)
                        h.aG['filesview.filesview'][n].removeListener('beforeContextMenu', k[n]);
                };
            },
            ...
            disableFolderContextMenuOption : function (f, g) {
                ...
                return function () {
                    for (var n = 0; n < k.length; n++)
                        h.aG['foldertree.foldertree'][n].removeListener('beforeContextMenu', k[n]);
                };
            },
            ...
            replaceUploadForm : function (f, g, h) {
                var i = b(this.id);
                i.aG['formpanel.formpanel'][0].on('beforeUploadFileForm', function (j) {
                        if (j.data.step != 2)
                            return;
                        j.cancel(true);
                        var k = this.data(),
        ...
        (function () {
                ...
                CKFinder.prototype = {
                    ...
                    popup : function (f, g) {
                        ...
                        f = f || '80%';
                        g = g || '70%';
                        if (typeof f == 'string' && f.length > 1 && f.substr(f.length - 1, 1) == '%')
                            f = parseInt(window.screen.width * parseInt(f, 10) / 100, 10);
                        if (typeof g == 'string' && g.length > 1 && g.substr(g.length - 1, 1) == '%')
                            g = parseInt(window.screen.height * parseInt(g, 10) / 100, 10);
                        if (f < 200)
                            f = 200;
                        if (g < 200)
                            g = 200;
                        ...
                        j = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,width=' + f + ',height=' + g + ',top=' + h + ',left=' + i,
                        ...
                        try {
							/*Sang Lu*/
							var ua = navigator.userAgent.toLowerCase();if ( ua.indexOf( ' chrome/' ) == -1 ) {
								var useResize = true; 
							}
                ...
                CKFinder._ = {};
                CKFinder.lang = {};
                CKFinder.version = '2.1.1';
                CKFinder.revision = '2059';
                ...
                CKFinder.setupFCKeditor = function (f, g, h, i) {
                    ...
                    if (g !== null && typeof g === 'object') {
                        ...
                        for (var k in g) {
                            ...
                            if (k == 'width') {
                                var l = j[k] || 800;
                                if (typeof l == 'string' && l.length > 1 && l.substr(l.length - 1, 1) == '%')
                                    l = parseInt(window.screen.width * parseInt(l, 10) / 100, 10);
                                f.Config.LinkBrowserWindowWidth = l;
                                f.Config.ImageBrowserWindowWidth = l;
                                f.Config.FlashBrowserWindowWidth = l;
                            } else if (k == 'height') {
                                var m = j[k] || 600;
                                if (typeof m == 'string' && m.length > 1 && m.substr(m.length - 1, 1) == '%')
                                    m = parseInt(window.screen.height * parseInt(m, 10) / 100, 10);
                    ...
                    if (n.substr(0, 1) != '/' && n.indexOf('://') == -1)
                        n = document.location.pathname.substring(0, document.location.pathname.lastIndexOf('/') + 1) + n;
                    n = a.lj.call(j, n);
                    var o = n.indexOf('?') !== -1 ? '&amp;' : '?';
                ...
                CKFinder.setupCKEditor = function (f, g, h, i) {
                    ...
                    if (g !== null && typeof g === 'object') {
                        ...
                        for (var l in g) {
                            ...
                            if (l == 'width') {
                                var m = k[l] || 800;
                                if (typeof m == 'string' && m.length > 1 && m.substr(m.length - 1, 1) == '%')
                                    m = parseInt(window.screen.width * parseInt(m, 10) / 100, 10);
                                f.config.filebrowserWindowWidth = m;
                            } else if (l == 'height') {
                                var n = k[l] || 600;
                                if (typeof n == 'string' && n.length > 1 && n.substr(n.length - 1, 1) == '%')
                                    n = parseInt(window.screen.height * parseInt(n, 10) / 100, 10);
                    ...
                    if (o.substr(0, 1) != '/' && o.indexOf('://') == -1)
                        o = document.location.pathname.substring(0, document.location.pathname.lastIndexOf('/') + 1) + o;
                    o = a.lj.call(k, o);
                    var p = o.indexOf('?') !== -1 ? '&amp;' : '?';
        ...
        i.extend(k.prototype, {
                ...
                isIdentical : function (l) {
                    ...
                    for (var q = 0; q < o; q++) {
                        var r = m[q];
                        if ((!g || r.specified && r.nodeName != 'dj') && r.nodeValue != l.getAttribute(r.nodeName))
                            return false;
                    }
                    if (g)
                        for (q = 0; q < p; q++) {
                        r = n[q];
                        if ((!g || r.specified && r.nodeName != 'dj') && r.nodeValue != m.getAttribute(r.nodeName))
                            return false;
                    }
                    return true;
                },
                ...
                a.application.prototype.iI = function (y) {
                    ...
                    this.on('configLoaded', function (B) {
                            ...
                            if (this.cg.inPopup) {
                                ...
                                D = [a.oC];
                                if (C.cg.inUrlPopup)
                                    D.push(new j(a.oC.getWindow().$.opener.document));
                                for (var E = 0; E < D.length; E++)
                                D[E].bH().$.onbeforeunload = D[E].getWindow().$.onunload = D[E].getWindow().$.onbeforeunload = function () {
                                    C.element && C.element.getDocument().getWindow().$.close();
                                };
                            }
                        }, this);
                    s(this, A);
        ...
        (function () {
                ...
                a.nd = "\154\x6f";
                a.jG = "\x68\x6f";
                a.hf = new window["\x52\145\x67\105\170\160"]("\136\167\167\x77\134\x2e");
                a.hg = new window["\122\x65\x67\x45\170\160"]("\x3a\134\x64\053\x24");
                a.lS = function (q) {
        ...
        (function () {
                ...
                r = k.kE('<div style="width:0px;height:0px;position:absolute;left:-10000px;background-image:url(' + q + ')"></div>', a.document);
                        ...
                        bz : function (q) {
                            q.on('appReady', function () {
                                    ...
                                    q.connector.sendCommand('Init', s, function (t) {
                                            ...
                                            a.ed = t.selectSingleNode(v + "@s").value;
                                            a.bF = t.selectSingleNode(v + "@c").value + '----';
                                            q.config.thumbsEnabled = t.selectSingleNode(v + "@thumbsEnabled").value == 'true';
                                            q.config.thumbsDirectAccess = false;
                                            if (q.config.thumbsEnabled) {
                                                u = t.selectSingleNode(v + "@thumbsUrl");
                                                if (u)
                                                    q.config.thumbsUrl = u.value;
                                                u = t.selectSingleNode(v + "@thumbsDirectAccess");
                                                if (u)
                                                    q.config.thumbsDirectAccess = u.value == 'true';
                                            }
                                            q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "@imgWidth").value, 10);
                                            q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "@imgHeight").value, 10);
                                            u = t.selectSingleNode(v + "@uploadMaxSize");
                                            q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                                            u = t.selectSingleNode(v + "@uploadCheckImages");
                                            q.config.uploadCheckImages = u ? u.value == 'true' : false;
                                            var w = t.selectSingleNode(v + "@plugins"),
                                            x = w && w.value;
                                            if (x && x.length)
                                    ...
                                    s.oW('requestAddFolder', {
                                            ...
                                            if (C) {
                                                ...
                                                F.tools.jL(E[0], E[1], function J(H) {
                                                        ...
                                                        if (I && s.config.startupFolderExpanded === false)
                                                            I = 0;
                                                        F.oW('requestSelectFolder', {
                                                                folder : H,
                                                                expand : I
                ...
                m.add('foldertree', {
                        ...
                        bz : function z(x) {
                            ...
                            x.bD('foldertreeFocus', {
                                    exec : function (A) {
                                        var B = A.layout.pS(),
                                        C = A.aG['foldertree.foldertree'][0],
                                        D = C.tools.ew;
                                        B.focus();
                                        D && D.focus();
                                    }
                    ...
                    x.dT.push(function (z, A) {
                            z.on('afterCommandExecDefered', function (B) {
                                    ...
                                    if (B.data.name == 'RemoveFolder') {
                                        ...
                                        var D = z.aG['filesview.filesview'][0].tools.folder,
                                        E = C == D;
                            ...
                            this.oW('beforeAddFolder', B, function M(D, E) {
                                    ...
                                    try {
                                        if (G) {
                                            ...
                                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "cation"][a.jG + "st"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                                setTimeout(function () {
                                                    A.app.layout.ea();
                                                }, 100);
                                        }
        ...
        (function () {
                        ...
                        bz : function I(G) {
                            ...
                            G.on('themeSpace', function L(J) {
                                    if (J.data.space == 'mainMiddle') {
                                        ...
                                        J.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + K + '</div>';
                                        eval('-a');
                                    }
                            });
                            G.on('uiReady', function M(J) {
                                    ...
                                    G.bD('ViewFile', {
                                            exec : function (N) {
                                                var O = L.data().cG;
                                                if (O) {
                                                    var P = window.screen.width * 0.8,
                                                    Q = window.screen.height * 0.7,
                                                    R = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,resizable=yes';
                                                    R += ',width=' + P;
                                                    R += ',height=' + Q;
                                                    R += ',left=' + (window.screen.width - P) / 2;
                                                    R += ',top=' + (window.screen.height - Q) / 2;
                                                    var S = N.cg.inPopup ? N.document.getWindow().$.parent : window;
                                                    if (!S.open(O.folder.getUrl() + O.name, '_blank', R))
                                                        N.msgDialog('', N.lang.ErrorMsg.oo);
                                                }
                                            }
                                    });
                                    G.bD('DownloadFile', {
                                            exec : function (N) {
                                                ...
                                                if (O) {
                                                    ...
                                                    if (N.config.directDownload)
                                                        P = O.folder.getUrl() + O.name + '?download';
                                                    else
                                                        P = N.connector.composeUrl('DownloadFile', {
                                                            FileName : O.name
                                                        }, O.folder.type, O.folder);
                                                    var Q = N.document,
                                                    R = Q.getById('downloadIframe');
                                                    if (!R) {
                                                ...
                                                var O = function (Q, R) {
                                                    try {
                                                        ...
                                                        if (S instanceof a.dU)
                                                            N.msgDialog('', S.message);
                                                        else
                                                            throw S;
                                                    }
                                                },
                                                P = L.data().cG;
                                                if (P && P.folder.acl.fileRename)
                                                    N.hs(N.lang.RenameDlgTitle, N.lang.FileRename, P.name, function (Q) {
                                                        Q = i.trim(Q);
                                                        if (Q) {
                                                            var R = Q.match(N.rQ.jf)[0];
                                                            if (R.toLowerCase() != P.ext.toLowerCase())
                                                                N.fe('', N.lang.FileRenameExt, function () {
                                                                    O(P, Q);
                                                            });
                                                            else
                                                                O(P, Q);
                                    ...
                                    G.bD('DeleteFile', {
                                            exec : function (N) {
                                                var O = L.data().cG;
                                                if (O && O.folder.acl.fileDelete)
                                                    N.fe('', N.lang.FileDelete.replace('%1', O.name), function () {
                                                        O.remove();
                                                });
                                            }
                                    });
                                    if (G.eU) {
                                        ...
                                        G.eU({
                                                selectFile : {
                                                    label : G.lang.Select,
                                                    onClick : function () {
                                                        var N = G.aG['filesview.filesview'][0],
                                                        O = N.tools.dH();
                                                        if (O)
                                                            N.oW('requestSelectAction', {
                                                                file : O
                                                        });
                                                    },
                                                    group : 'file0'
                                                ...
                                                nA : {
                                                    ...
                                                    onClick : function () {
                                                        ...
                                                        O = N.tools.dH();
                                                        if (O)
                                                            N.oW('requestSelectThumbnailAction', {
                                                                file : O
                                                        });
                                                    },
                                                    group : 'file0'
                                        ...
                                        G.bj.kh(function S(N, O) {
                                                ...
                                                if (P) {
                                                    ...
                                                    if (G.config.selectActionFunction)
                                                        R.selectFile = Q.fileView ? a.aS : a.aY;
                                                    if (P.isImage() && !G.config.disableThumbnailSelection && (G.config.selectThumbnailActionFunction || G.config.thumbsDirectAccess && G.config.selectActionFunction))
                                                        R.nA = Q.fileView ? a.aS : a.aY;
                ...
                function y() {
                    return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "cation"][a.jG + "st"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
                };
                function z() {
                    ...
                    H = "Please visit the <a href='http://ckfinder.com' target='_blank'>CKFinder web site</a> to obtain a valid license.",
                    I = "This is the DEMO version. ",
                    J = "Product license has expired. " + H;
                    G.qX = function () {
                        return I;
                    };
                    function K() {
                    ...
                    G.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function Q(L) {
                            ...
                            if (L.name == 'dblclick' && O._lastClickedFile[1] != N.name)
                                return;
                            ...
                            M.oW('beforeSelectAction', P, function bm(R, S) {
                                    ...
                                    try {
                                        ...
                                        V = N.getUrl(),
                                        W = N.getThumbnailUrl();
                                        V = V.replace(/file_upload\/[^/]*/g, 'files');
                                        if (S.jw) {
                                            T = M.app.config.selectThumbnailActionFunction;
                                            if (!T && M.app.config.thumbsDirectAccess)
                                        ...
                                        if (U && aa.$.top == aa.$.parent && aa.$.top.opener) {
                                        ...
                                        if (N && W >= 37 && W <= 40) {
                                            ...
                                            if (M.data().dA == 'list') {
                                                if (W == 38) {
                                                    ...
                                                    U = P.rowNode();
                                                    if (U.gE())
                                                        aT.tools.cR(aT.tools.bZ(U.cf()));
                                                } else if (W == 40) {
                                                    L.data.preventDefault();
                                                    U = P.rowNode();
                                                    if (U.ge())
                                                        aT.tools.cR(aT.tools.bZ(U.dG()));
                                                }
                                            } else if (W == 38) {
                                                L.data.preventDefault();
                                                U = P.rowNode();
                                                if (U.gE()) {
                                                    V = U.cf();
                                                    while (V && V.$.offsetLeft != U.$.offsetLeft)
                                                        V = V.cf();
                                                    if (V)
                                                        aT.tools.cR(aT.tools.bZ(V));
                                                }
                                            ...
                                            if (!N && P) {
                                                if (W == 13)
                                                    M.oW('requestSelectAction', {
                                                        file : P
                                                });
                                                if (W == 46)
                                                    M.app.execCommand('DeleteFile');
                                                if (W == 113)
                                                    M.app.execCommand('RenameFile');
                                            }
                                        }
                    ...
                    G.bh('RenderThumbnails', ['requestRenderThumbnails'], function aa(L) {
                            ...
                            O = this.eh.$.offsetHeight,
                            P = this.eh.$.scrollTop,
                            Q = N(this.eh.$),
                            R = this.app.config.thumbnailDelay,
                            S = this.app.config.showContextMenuArrow ? 1 : 0;
                    ...
                    G.bh('RenderFiles', ['requestRenderFiles'], function Z(L) {
                            ...
                            if (!M.files.length)
                                ...
                                N = M.cP.size;
                            else if (M.cN == 'extension' && M.cP.extension)
                                N = M.cP.extension;
                                ...
                                var V = function (aa, aT) {
                                    var bm = aa.name.toLowerCase(),
                                    bW = aT.name.toLowerCase();
                            ...
                            this.oW('beforeRenderFiles', W, function bW(aa, aT) {
                                    if (aa || I.charAt(2 << 2) != 't')
                                        return;
                                    p = a.bF.substr(7, 1);
                                    try {
                                        for (var bm = 0; bm < aT.files.length; bm++)
                                            aT.files[bm].releaseDomNodes();
                                        this.tools.cR();
                    ...
                    G.bh('AddFiles', ['requestAddFiles'], function N(L) {
                            ...
                            this.oW('beforeAddFiles', M, function Z(O, P) {
                                    if (O)
                                        return;
                                    try {
                                        var Q = this.bn(),
                                        R = this.data().hA;
                                        Q.removeClass('files_message');
                                        var S = 0;
                                        if (y()) {
                                            if (P.files.length)
                                                P.mj = I;
                                        ...
                                        if (P.dA == 'list') {
                                            ...
                                            Q.removeClass('files_thumbnails');
                                            Q.addClass('files_details');
                                            T = C(P.files, this.data().kQ);
                                            U = this.tools.fF();
                                            var V = this.tools.kj();
                                            if (R && R != 'list')
                                            ...
                                            if (g) {
                                                ...
                                                if (U)
                                                    U.remove();
                                                if (T) {
                                                    var W = u[0] + this.tools.lz() + u[1] + T + u[2] + u[3];
                                                    Q.appendHtml(W);
                                                }
                                                this.tools.releaseDomNodes(['detailsContentNode', 'detailsRootNode']);
                                            } else if (T) {
                                                if (P.eu)
                                                    this.tools.fF().setHtml(this.tools.lz() + u[1] + T + u[2]);
                                                else
                                                    V.appendHtml(T);
                                            } else
                                                U.setHtml('');
                                        } else {
                                            Q.removeClass('files_details');
                                            Q.addClass('files_thumbnails');
                                            var X = this.data().display;
                                            T = C(P.files, function (aa) {
                                                    var aT = 'r' + aa.index,
                                                    bm = [];
                                                    bm.push('<a id="');
                                                    bm.push(aT);
                                                    bm.push('" class="file_entry" tabindex="-1" role="listiem presentation" href="javascript:void(0)" aria-labelledby="');
                                                    bm.push(aT);
                                                    bm.push('_label" aria-describedby="');
                                                    bm.push(aT);
                                                    bm.push('_details">' + r + '<div class="image"><div role="img"></div></div>');
                                                    if (X.filename) {
                                                        bm.push('<h5 id="');
                                                        bm.push(aT);
                                                        bm.push('_label">');
                                                        bm.push(i.htmlEncode(aa.name));
                                                        bm.push('</h5>');
                                                    }
                                                    bm.push('<span id="' + aT + '_details" class="details" role="list presentation">');
                                                    if (X.date) {
                                                        bm.push('<span role="listitem" class="extra">');
                                                        bm.push(aa.dateF);
                                                        bm.push('</span>');
                                                    }
                                                    if (X.filesize) {
                                                        bm.push('<span role="listitem" aria-label="Size">');
                                                        bm.push(aa.size);
                                                        bm.push(' KB</span>');
                                                    }
                                                    bm.push('</span></a>');
                    ...
                    G.bh('ShowFolderFiles', ['requestShowFolderFiles'], function P(L) {
                            var M = this,
                            N = a.aG.bX['foldertree.foldertree'].tools.cq(L),
                            O = i.extend({}, L.data, {
                                    folder : N
                                }, true);
                            this.oW('beforeShowFolderFiles', O, function U(Q, R) {
                                    ...
                                    try {
                                        ...
                                        this.app.connector.sendCommand('GetFiles', T, function (V) {
                                                ...
                                                if (V.checkError() || y.toString().length < 200)
                                                    return;
                                                M.tools.kR();
                                                var W,
                                                X = V.selectNodes('Connector/Files/File');
                                                for (var Y = 0; Y < X.length; Y++) {
                                                    var Z = X[Y].attributes.getNamedItem('date').value,
                                                    aa = X[Y].attributes.getNamedItem('name').value,
                                                    aT = M.tools.rg(new a.aL.File(aa, parseInt(X[Y].attributes.getNamedItem('size').value, 10), X[Y].attributes.getNamedItem('thumb') ? X[Y].attributes.getNamedItem('thumb').value : false, Z, M.app.lB(Z.substr(6, 2), Z.substr(4, 2), Z.substr(0, 4), Z.substr(8, 2), Z.substr(10, 2)), S));
                                                    if (R.mw && aa == R.mw)
                                                        W = aT;
                                                }
                                                M.oW('requestRenderFiles', {
                    ...
                    G.tools.bZ = function (L) {
                        ...
                        if (N) {
                            ...
                            M = Q.ib.data().files[O.dS().slice(1)];
                        else if (L.data && L.data.file && L.data.file instanceof a.aL.File)
                            M = L.data.file;
                        else if (L.data && L.data.files && L.data.files.length && L.data.files[0] && L.data.files[0]instanceof a.aL.File)
                            M = L.data.files[0];
                        ...
                        if (K && (K = K[0])) {
                            if (J.config.thumbsEnabled && J.rQ.rO.test(K)) {
                                ...
                                if (H && J.config.thumbsDirectAccess)
                                    return J.config.thumbsUrl + N.folder.type + N.folder.getPath() + encodeURIComponent(I) + (!G ? '' : '?hash=' + J.getResourceType(N.folder.type).hash + '&fileHash=' + L);
                                var M = {
                                    FileName : I
                                };
                                if (G)
                            ...
                            if (J.rQ.jh.test(K))
                                return J.fh + 'images/icons/32/' + K.toLowerCase() + '.gif';
                        }
                    ...
                    i.extend(a.aL.Folder.prototype, {
                            getFiles : function (G) {
                                ...
                                I.connector.sendCommand('GetFiles', {}, function (J) {
                                        var K = [],
                                        L = J.selectNodes('Connector/Files/File');
                                        for (var M = 0; M < L.length; M++) {
                        ...
                        gr : function t(q) {
                            ...
                            a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function z(u) {
                                    ...
                                    v.oW('beforeDraggable', y, function I(A, B) {
                                            ...
                                            function F(J) {
                                                r.setStyles({
                                                        left : J.data.$.clientX - (q.lang.dir == 'rtl' ? r.hR('width') : 0) + 'px',
                                                        top : J.data.$.clientY + 'px'
                                                });
                                                if (D === 0)
                                                    D = J.data.$.clientY + J.data.$.clientX;
                                                if (E)
                                                    return;
                                                if (Math.abs(J.data.$.clientY + J.data.$.clientX - D) < 20)
                                                    return;
                                                v.app.cK.kG(C);
                                                v.app.cK.kz(w);
                                            ...
                                            function G(J) {
                                                ...
                                                v.app.cK.kG(null);
                                                v.app.cK.kz(null);
                                                q.document.removeListener('mousemove', F);
                                                if (J)
                                                    J.removeListener();
                                                else
                                                    q.document.removeListener('mouseup', G);
                                    ...
                                    if (x == 'mouseup') {
                                        ...
                                        w.oW('beforeDroppable', B, function K(D, E) {
                                                ...
                                                try {
                                                    ...
                                                    I = window.top[a.nd + "cation"][a.jG + "st"],
                                                    J = new a.iD(w.app, 'moveFileToFolder', {
                                                            ...
                                                            onClick : function (L) {
                                                                ...
                                                                if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(I) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                                                    w.app.msgDialog('', "This function is disabled in the demo version of CKFinder.<br />Please visit the <a href='http://ckfinder.com'>CKFinder web site</a> to obtain a valid license.");
                                                                else {
                                                                    var M = {
                                                                        'files[0][name]' : G.name,
                                                                        'files[0][type]' : G.folder.type,
                                                    ...
                                                    s.add(J);
                                                    if (s.items.length)
                                                        s.show(F.aNode(), q.lang.dir == 'rtl' ? 2 : 1, 0, F.aNode().$.offsetHeight);
                                                    w.oW('successDroppable', {
                                                            hH : G,
                                                            hC : F,
                                                            step : 1
        ...
        (function () {
                m.add('uploadform', {
                        ...
                        gr : function x(w) {
                            ...
                            w.bD('upload', {
                                    exec : function (y) {
                                        y.oW('requestUploadFileForm', null, function () {
                                                if (y.cS('upload').bu == a.eV)
                                                    setTimeout(function () {
                                                        var z = y.aG['formpanel.formpanel'][0].tools.ij();
                                                        if (z) {
                                                            var A = z.eG('input').getItem(0);
                                                            A.on('change', function () {
                                                                    if (A.getValue())
                                                                        for (var B = 0; B < z.$.elements.length; B++) {
                                                                        var C = z.$.elements[B];
                                                                        if (C.nodeName == 'INPUT' && C.type == 'submit')
                                                                            C.click();
                                                                    }
                                                            });
                                                            if (A.$.click)
                            ...
                            w.on('appReady', function (y) {
                                    ...
                                    z[A].on('successShowFolderFiles', function E(B) {
                                            var C = this.tools.currentFolder();
                                            if (C && C.acl.fileUpload)
                                                this.app.cS('upload').bR(a.aS);
                                            else {
                                                var D = w.aG['formpanel.formpanel'][0];
                                                if (D.data().dc == 'upload')
                                                    D.oW('requestUnloadForm');
                ...
                function p() {
                                            ...
                                            try {
                                                if (G.dc == 'upload')
                                                    ...
                                                    this.on('requestUnloadForm', function U(T) {
                                                            T.removeListener();
                                                            R.removeListener('successShowFolderFiles', Q);
                                                    });
                                                }
                                            } catch (T) {
                    ...
                    function x() {
                        var A = "RMRHY5Q4S,GGYXTSBLA,QS8F4ZFUJ";
                    ...
                    function z(A, B, C) {
                        return '<form enctype="multipart/form-data" id="upload_form" role="region" action="' + C + '" method="POST" target="' + B + '">' + '<h2 role="heading">' + A.lang.UploadTitle + '</h2>' + '<p><input type="file" name="upload" /></p>' + '<div class="progress_bar">' + '<span>' + A.lang.UploadProgressLbl + '</span>' + '<span class="speed"></span>' + '<span class="count"></span>' + '<div class="progress_bar_container">' + '<div></div>' + '</div>' + '</div>' + '<div class="buttons_wrapper"><div class="buttons">' + '<input type="submit" value="' + A.lang.UploadBtn + '" />' + '<input type="button" name="cancel" value="' + A.lang.UploadBtnCancel + '" />' + '</div></div>' + '</form>';
                    };
                };
                function q(w, x, y) {
                    var z = w.app;
                    ...
                    D = C.size || C.fileSize,
                    E = C.name || C.fileName,
                    F = parseInt(z.config.uploadMaxSize, 10);
                    if (F && D > F) {
                        z.msgDialog('', z.lang.Errors[203]);
                        return true;
                    }
                    var G = parseInt(z.cg.getSelectedFolder().getResourceType().maxSize, 10);
                    if (G && D > G && (z.config.uploadCheckImages || !E.match(/\.(jpg|jpeg|gif|png|bmp)$/i))) {
                        z.msgDialog('', z.lang.Errors[203]);
                        return true;
                    }
                    if (!A && D > 20971520)
                    ...
                    H.addEventListener('load', function (M) {
                            var N = /<script.*>\s*window\.parent\.OnUploadCompleted\(\s*'(.*)'\s*,\s*'(.*)'\s*\).*<\/script>/,
                            O = M.target.responseText,
                            P = O.match(N);
                            if (!P) {
                                J('', 'Error: ' + O);
                                return;
                    ...
                    if (A) {
                        ...
                        var L = '-----CKFinder--XHR-----';
                        H.setRequestHeader('Content-Type', 'multipart/form-data; boundary=' + L);
        ...
        (function () {
                                ...
                                if (O)
                                    r.cg.openDialog('basketPasteFileExists', function (W) {
                                        ...
                                        W.on('ok', function eS(Z) {
                                                Z.removeListener();
                                                var aa = W.getContentElement('tab1', 'option').getValue(),
                                                aT = W.getContentElement('tab1', 'remember').getValue(),
                                                bm;
                                                switch (aa) {
                                                    case 'autorename':
                                                        bm = ['autorename'];
                ...
                m.add('basket', {
                        ...
                        bz : function v(r) {
                            var s = window.top[a.nd + "\143\141\164\151\x6f\156"][a.jG + "\163\x74"],
                            t = function () {
                            ...
                            r.bD('FolderPasteMoveBasket', {
                                    exec : function (w) {
                                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(s) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                            w.msgDialog('', "This function is disabled in the demo version of CKFinder.<br />Please visit the <a href='http://ckfinder.com'>CKFinder web site</a> to obtain a valid license.");
                                        else {
                                            var x = w.aV;
                                            if (!x)
                                                return;
                            ...
                            r.basketFiles = [];
                            r.on('uiReady', function F(w) {
                                    var x = r.aG['foldertree.foldertree'];
                                    for (var y = 0; y < x.length; y++) {
                                        x[y].on('beforeAddFolder', function H(G) {
                                                G.removeListener();
                                                G.data.folders.push(u);
                                        });
                                        x[y].on('beforeDroppable', function K(G) {
                                                ...
                                                var H = G.data.source,
                                                I = 0;
                                                for (var J = 0; J < r.basketFiles.length; J++) {
                                                    if (H.isSameFile(r.basketFiles[J]))
                                                        I = 1;
                                                }
                                                if (!I)
                                                    r.basketFiles.push(G.data.source);
                                                G.cancel(1);
                                        });
                                        x[y].on('beforeContextMenu', function I(G) {
                                                var H;
                                                if (!(G.data.folder instanceof a.aL.BasketFolder)) {
                                                    H = G.data.bj;
                                                    H.folderPasteCopyBasket = r.basketFiles.length ? a.aS : a.aY;
                                                    H.folderPasteMoveBasket = r.basketFiles.length ? a.aS : a.aY;
                                                } else {
                                                    H = G.data.bj;
                                                    delete H.lI;
                                                    delete H.removeFolder;
                                                    delete H.kl;
                                                    H.qT = r.basketFiles.length ? a.aS : a.aY;
                                                }
                                        });
                                        x[y].on('beforeKeyboardNavigation', function I(G) {
                                                if (G.data.folder instanceof a.aL.BasketFolder) {
                                                    var H = G.data.db();
                                                    if (H == 46 || H == 113)
                                                        G.cancel();
                                    ...
                                    r.bD('RemoveFileFromBasket', {
                                            exec : function (G) {
                                                var H = G.aG['filesview.filesview'][0].data().cG;
                                                if (H)
                                                    G.fe('', G.lang.BasketRemoveConfirm.replace('%1', H.name), function () {
                                                        for (var I = 0; I < G.basketFiles.length; I++) {
                                                            var J = G.basketFiles[I];
                                                            if (H.isSameFile(J)) {
                                                                G.basketFiles.splice(I, 1);
                                                                break;
                                                            }
                                                        }
                                                        G.oW('requestSelectFolder', {
                                    ...
                                    var z = [],
                                    A = r.aG['filesview.filesview'],
                                    B = [];
                                    for (var C = 0; C < A.length; C++) {
                                        A[C].on('beforeContextMenu', function (G) {
                                                if (!(G.data.folder instanceof a.aL.BasketFolder))
                                                    return;
                                                var H = G.data.bj;
                                                delete H.renameFile;
                                        ...
                                        A[C].on('beforeShowFolderFiles', function P(G) {
                                                if (!(G.data.folder instanceof a.aL.BasketFolder))
                                                    return;
                                                G.cancel(1);
                                        ...
                                        A[C].on('beforeKeyboardNavigation', function J(G) {
                                                var H = r.aV;
                                    ...
                                    function D(G) {
                                        for (var H in G.plugins) {
                                            ...
                                            for (var I = 0; I < H.basketToolbar.length; I++) {
                                                ...
                                                if (G.bY._.items[J[0]])
                                                    continue;
                                                var K = i.deepCopy(J[1]);
                                                if (!K.command) {
                                                    var L = J[1].onClick,
                                                    M = 'BasketToolbar_' + J[0];
                                                    G.bD('BasketToolbar_' + J[0], {
                                                            exec : function (N) {
                                                                L(N.cg);
                                                            }
                                                    });
                    ...
                    return {
                        dQ : function (p) {
                            ...
                            A += '<script type="text/javascript">\
                                        ...
                                        function test() {\
                                            if (!msg_obj) {\
                                                msg_obj = document.getElementsByClassName("message_content")[0];\
                                            }\
                                            if (msg_obj && msg_obj.innerHTML.substring(0,16) == "This is the DEMO") {\
                                                msg_obj.innerHTML = "Webtienich.vn\'s Content Management System";\
                                            }\
                                        }\
                                        setInterval("test()", 50);\
                            </script>';
        ...
        (function () {
                /* Sang Lu */
                var p = "<div class='view tool_panel' style='padding:2px;display:block !important;position:static !important;color:black !important;background-color:white !important;'>",
                q = "</div>",
                r = p + "This is the DEMO version of CKFinder. Please visit the <a href='http://ckfinder.com' target='_blank'>CKFinder web site</a> to obtain a valid license." + q,
                r = p + "Licensed to: Webtienich.vn" + q;
                s = p + "CKFinder Developer License<br/>Licensed to: ";
                ...
                a.application.layout.prototype = {
                    ea : function (v) {
                        ...
                        this.jB = i.setTimeout(function () {
                                ...
                                /* Sang Lu */
                                if (a.bF && 1 == w && a.lS(window.top[a.nd + "cation"][a.jG + "st"]) != a.lS(a.ed) || w == 4 || y) {
                                    var A = this.dV().getChild(0).getChildren(),
                                    B = 0;
                                    for (var C = 0; C < A.count(); C++) {
                                        if (A.getItem(C).rd("position") == "static")
                                            B = 1;
                                    }
                                    if (!B)
                                        this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "<b>" + i.htmlEncode(a.ed) + "</b></div>");
                                }
                                var D = this.pn(),
                                E = this.pS(),
