...
<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" 
	...
	<div class="m-portlet__body">
		<div class="form-group m-form__group row">
			<div class="col-lg-4">
				<label class="required">Tên công việc (ID: <?php echo $row['congviec_id'] ?> ) : 
				</label>
		...
		<div class="form-group m-form__group row">
			<div class="col-lg-4">
				<label>Độ tuổi:</label>
				<input type="text" name="dotuoi" value="<?php echo $row['dotuoi'] ?>" class="form-control m-input" maxlength="50">
				<p class="has-error"></p>
			</div>
			<div class="col-lg-4">
				...
				<?php if(!empty($row['sonamkinhnghiem'])){ ?>
					...
					class="form-control m-input sonamkinhnghiem"
				...
				<div class="col-xl-12 col-lg-12">
					<script>
						$(document).ready(function(){
							...
							$("#tinhthanh").val(tinhthanhArray).trigger('change');
						});
					</script>
			...
			<div class="col-lg-4">
				...
				<div class="m-checkbox-list">
					<label class="m-checkbox">
						...
						<?php 
						 if(!empty($row['trangthai']))
						 {
							 echo 'checked';
						 }else if($row['post_basic'] == 1)
						 {
							  echo 'checked';
						 }else
						 {
		...
		<div class="form-group m-form__group row">
			<div class="col-lg-4">
				<label class=""><strong>HOT JOB:</strong></label>
				<div class="m-checkbox-list">
					<label class="m-checkbox">
						<input name="hot_job" <?php if($row['hot_job'] == 1){echo 'checked';}else{echo '';} ?> value="1" type="checkbox">
						Check vào ô
						<span></span>
					</label>
				</div>
			...
			<div class="col-lg-4">
				<label class=""><strong>POWER JOB: </strong></label>
				<div class="m-checkbox-list">
					<label class="m-checkbox">
						<input name="power_job" value="1" <?php echo !empty($row['power_job']) ? 'checked' : '' ?> type="checkbox">
						Check vào ô
						<span></span>
					</label>
				</div>
	...
	<input type="hidden" name="post_basic" value="<?php echo $row['post_basic'] ?>">
