<div id="content-box">
		...
		<div id="element-box">
			...
			function submitbutton(pressbutton) {
				...
				else if(checkValue == "rdoProductCategories2"){
					if (trim( form.select_product_category_page_2.value ) == 0){
						alert( "Vui lòng chọn danh mục sản phẩm cần liên kết cho menu moi" );
						form.select_product_category_page_2.focus();
						return;
					}
				} 
				...
				function ChangeLink(k) {
					...
					var objNewsArticle = document.getElementById('news_article_page');
					 ...
					 var objProductCategories = document.getElementById('product_category_page');
					  var objProductCategories_2 = document.getElementById('product_category_page_2');
									...
									<tr>
										...
										<td>
											<div>
                                                ...
                                                <input id="rdoProductCategories2" type="radio" name="rdotype" value="rdoProductCategories2" onclick="javascript:return ChangeLink(9);"> <label for="rdoProductCategories">Danh mục sản phẩm mới</label>
											</div>
											...
											<div id="product_category_page_2" style="min-height:150px;display:none">
												<?php
												...
												?>
												<select name="select_product_category_page_2" id="select_product_category_page_2" class="inputbox" size="10" style="width:306px;">
													<option value="0"  selected="selected">Chọn danh mục</option>
