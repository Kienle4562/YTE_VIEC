...
<head>
	<?php
		...
		include_once("components/com_career/template/1/print.php");
		include_once("components/com_career/template/1/temp.php");
		include_once("components/com_career/template/1/bootstrap.php");
