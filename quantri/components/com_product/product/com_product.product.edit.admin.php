            ...
            <div class="padding">
                <div id="toolbar-box">
                    ...
                    <div class="m">
                            ...
                            <table class="toolbar">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="button" id="toolbar-save">
                                            <a href="javascript:submitbutton('save')" class="toolbar">
                                        ...
                                        <td class="button" id="toolbar-apply">
                                            <a href="javascript:submitbutton('apply')" class="toolbar">
                        ...
                        <div class="header icon-48-sections">Sản phẩm: <small>[ Chỉnh sửa ]</small></div>
                ...
                <div id="element-box">
                    ...
                    <div class="m">
                        ...
                        <script type="text/javascript" src="../myeditor/myfinder/ckfinder.js?sess=<?php echo uniqid(); ?>"></script>
                        ...
                        <?php
                            ...
                            {
                                extract($row);
                                $tabs = $myProcess->get_tabs($_GET['id']); ?>
                                
                                <script type="text/javascript">
                                    var tabCount = <?php echo $tabs->rowCount(); ?>;
                                            ...
                                            add: function(event, ui) {
                                                jQuery(ui.panel).append('\
                                                    <fieldset class="phpForm">\
                                                        ...
                                                        <input name="html_tab_id[' + tabCount + ']" value="-1" type="hidden" />\
                                                    </fieldset>');
                                            }
                                        });
                                    });
                                ...
                                <div id="tabs">
                                    <ul>
                                        ...
                                        <?php
                                            for ($i = 0; $i < $tabs->rowCount(); $i++)
                                            {
                                                echo '<li><a href="#new' . $i . '">Nội dung ' . ($i + 1) . '</a></li>';
                                            }
                                        ?>
                                    </ul>
                                                ...
                                                <tbody><tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <input type="text" id="image_file" name="image_file[]" value="<?php echo $image_name_array[0]; ?>" style="width:600px;">
                                                            ...
                                                            <table id="tblInnerHTML_img" style="margin-top:5px;" cellpadding="0" cellspacing="0" border="0" width="100%"> 
                                                                <tbody>
                                                                    <?php for($j=1; $j < count($image_name_array); $j++){ ?>
                                                                        <tr>
                                                                            <td>
                                                                                <div style="float: left;">
                                                                                    <input style="width:600px;" style="background: #ffffff;" type="text" id="image_file<?php echo $j-1; ?>" name="image_file[]" value="<?php echo $image_name_array[$j]; ?>" />
                                                                                    <input type="hidden" id="image_id" name="image_id[]" />
                                                                                </div>
                                                                                &nbsp;<a title="Chọn hình ảnh"  href="javascript:void(0)" onClick="javascript:BrowseServer('image_file<?php echo $j-1; ?>');"> + Lựa chọn + </a>
                                                                                &nbsp;&nbsp;&nbsp; <a href='javascript:void(0);' onClick="removeRowFromTable('tblInnerHTML_img','<?php echo $j-1; ?>');return false;"> <img src="templates/mt24h_admin/images/icons/job_icon_delete_12x12.gif" alt="" width="13" height="13" border="0" /> Xóa</a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php }	?>
                                                                </tbody>
                                                    ...
                                                    <td colspan="2">
                                                       <input class="text_area" name="size" id="size" placeholder="size(37,38..) or loại size (XL ,L ,M)..." size="50" maxlength="255" title="nhập kích cở" type="text" value="<?php echo $row['size_product'] ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="key">
                                                    ...
                                                    <td colspan="2">
                                                      <input class="text_area" name="color" id="color" placeholder="Colour enter spaced . ex : blue , black, white,..." size="50" maxlength="255" title="Please enter color" type="text" value="<?php echo $row['color_product'] ?>">
                                                    </td>
                                                </tr>
                                                    <tr>
                                                        <td class="key" nowrap="nowrap">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">						
                                                            <?php if($new_product == 0) {?>
                                                                <input name="new_product" id="new_product0" value="0" checked="checked" class="inputbox" type="radio">
                                                                <label for="new_product0">Không</label>
                                                                <input name="new_product" id="new_product1" value="1" class="inputbox" type="radio">
                                                                <label for="new_product1">Chọn</label>
                                                                <?php } else {?>
                                                                <input name="new_product" id="new_product0" value="0" class="inputbox" type="radio">
                                                                <label for="new_product0">Không</label>
                                                                <input name="new_product" id="new_product1" value="1" checked="checked" class="inputbox" type="radio">
                                                                <label for="new_product1">Chọn</label>
                                                                <?php } ?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <?php } else { ?>
                                                                <input name="show_comment" id="show_comment" value="1" class="inputbox" type="radio">
                                                                <label for="show_comment">Cho phép</label>
                                                                <input name="show_comment" id="dont_show_comment" value="0" checked="checked" class="inputbox" type="radio">
                                                                <label for="dont_show_comment">Không cho phép</label>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                          <input type="text" name="keyword" id="tags" value="<?php echo $keyword; ?>" data-role="tagsinput" title="Tags bÃ i viáº¿t" />     
                                                    ...
                                                    <table class="admintable" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <input class="text_area" name="html_tab_title[<?php echo $i; ?>]" value="<?php echo $tab['title']; ?>" size="80" maxlength="100" title="Tiêu đề thông tin" type="text">
                                                                    <a href="javascript:deleteCurrentTab()" class="deleteTab">Xoá thông tin này</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <textarea name="html_tabs[<?php echo $i; ?>]" id="html_tab_<?php echo $i; ?>"><?php echo $tab['content']; ?></textarea>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="key" nowrap="nowrap">
                                                                ...
                                                                <td colspan="2">
                                                                    <input name="html_tab_active[<?php echo $i; ?>]" value="0" <?php if ($tab['status'] == 0) { echo 'checked="checked"'; } ?> class="inputbox" type="radio">
                                                                    <label>Không cho phép</label>
                                                                    <input name="html_tab_active[<?php echo $i; ?>]" value="1" <?php if ($tab['status'] == 1) { echo 'checked="checked"'; } ?> class="inputbox" type="radio">
                                                                    <label>Cho phép</label>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <input name="html_tab_id[<?php echo $i; ?>]" value="<?php echo $tab['id']; ?>" type="hidden" />
                                                </fieldset>
                                                <script type="text/javascript">
                                                    CKEDITOR.replace('html_tab_<?php echo $i; ?>');
                                                </script>
                                            </div>
                                            <?php
                                            $i++;
                                ...
                                <input type="hidden" name="hidden" value="submit_com_product_edit" />
...
<script language="javascript">
    ...
    var intRowActive_img = <?php echo $j-1; ?>;
    ...
    function addImage(tblId)
    {
        ...
        var str = '<input type="text" id="image_file'+ intRowActive_img +'" name="image_file[]" value="Chọn file hình ảnh cần thêm .. " style="width:600px;" /><input type="hidden" id="image_id" name="image_id[]" />&nbsp;<a title="Chọn hình ảnh"  href="javascript:void(0)" onClick="javascript:BrowseServer('+"'image_file"+intRowActive_img+"'"+');"> + Lựa chọn + </a>';
