...
<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" 
	role="form" method="post" id="formDataUpdateCompany">
   ...
   <div class="col-lg-4">
      <label class="required">Gửi mail:</label>
...
<script>
	$('#formDataUpdateCompany .m_selectpicker').val();
	$('#formDataUpdateCompany .m_selectpicker').selectpicker();
	...
	jQuery(document).ready(function(){
		...
		$('#formDataUpdateCompany input[type=file]').on('change', function(event){
			
			uploadImageCompany(event, '<?php echo $com_name ?>', this.id, 1);
		});
