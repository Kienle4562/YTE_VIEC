<?php defined( '_VALID_MOS' ) or die( include_once("../../404.php") ); 
    ...
    include_once("mod_slideshow.handler.php");
...

					{
				        ...
				        <form method="post" name="phpForm">
					        ...
					        <div class="col width-50">
                                ...
                                <a class="backend_link" href="<?php echo $index_backend; ?>?com=mod_slideshow&view=folder&task=view" target="_blank">
                            ...
                            <input type="hidden" name="hidden" value="submit_mod_slideshow" />
