...
<title>Tạo Mật Khẩu Mới Tại Y Tế Việc</title>
                                        ...
                                        <tbody>
											<tr>
												<td style="color: #fefefe; font-weight: bold; font-family: Helvetica, Arial, sans-serif;">
													<h3>TẠO LẠI MẬT KHẨU MỚI TẠI Y TẾ VIỆC</h3>
												</td>
											</tr>
                                        </tbody>
									</table>
                    ...
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
						...
						<tr>
                            <td  class="main-header" style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                Chào mừng quý khách đến với Y Tế Việc
                            </td>
                        </tr>
                        <tr><td height="20"></td></tr>
                        <tr>
                            <td  class="main-subheader" style="color: #a4a4a4; font-size: 12px; font-weight: normal; line-height:20px; font-family: Helvetica, Arial, sans-serif;">
                                ...
                                Chúng tôi vừa nhận được thông tin tạo mật khẩu mới cho tài khoản của quý khách bằng Email này, quý khách vui lòng copy đoạn mã bên dưới và nhấn vào nút <b>Đặt mật khẩu mới</b>, sau khi vào trang đặt lại mật khẩu, quý khách vui lòng sử dụng mật mã mà chúng tôi cung cấp để tạo lại mật khẩu cho tài khoản của quý khách, sau khi tạo lại mật khẩu, quý khách có thể truy cập vào hệ thống của Y Tế Việc.
								Rất vui và hân hạnh khi được phục vụ quý khách, nếu quý khách không đăng ký thông tin tài khoản này vui lòng bỏ qua Email. Xin trân trọng cám ơn.

                            </td>
                        </tr>
						<tr ><td height="25"></td></tr>
						<tr>
							<td style="color: #a4a4a4; font-size: 14px; font-weight: bold; line-height:20px; font-family: Helvetica, Arial, sans-serif;">
								Mật mã: <?php echo $makichhoat ?>
							</td>
						</tr>
						<tr ><td height="25"></td></tr>
						<tr>
							<td>
								<a href="<?php echo $_SERVER['HTTP_HOST'] ?>?page=forget&code=<?php echo $makichhoat ?>&email=<?php echo $email ?>" style="background-color: #7087A3; font-size: 12px; padding: 10px 15px; color: #fff; text-decoration: none"> ĐẶT MẬT KHẨU MỚI</a>
							</td>
						</tr>
                        </tbody></table>
                </td>
...
<tr>
    <td  style="line-height: 16px;color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader" align="center">
        <span style="color: #7087A3">Contact Y Tế Việc: </span> contact@yteviec.com
    </td>
</tr>
<tr><td height="10"></td></tr>
</tbody></table>
...
<table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
    ...
    <tr bgcolor="7087A3">
        <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
            ...
            2018 © Y Tế Việc. All right reserved
