...
<head>
   <meta charset="utf8">
    <?php
		include_once("components/com_career/template/10/css/app.php");
		include_once("components/com_career/template/10/css/print.php");
		include_once("components/com_career/template/10/css/style.php");
		include_once("components/com_career/template/10/css/cv.php");
