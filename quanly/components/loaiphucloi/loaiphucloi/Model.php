<?php defined( '_VALID_MOS' ) or die( include("404.php") );
	...
	// Khai báo chung
    $com_name = "loaiphucloi";
	$title = "LOẠI PHÚC LỢI";
	$mota = "danh sách loại phúc lợi";
	$db_name = "mst_loaiphucloi";
	$primary_key = "loaiphucloi_id";
    ...
    */
    ...
    switch(@$_REQUEST["act"]){
		...
		case "LoadList";
			$column = "tenloaiphucloi,content,";
			$column .= "loaiphucloi_id,loaiphucloi_id as action_id";
