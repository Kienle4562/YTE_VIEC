...
<?php 
	...
	$sql = "SELECT `book_manufacturers`.`Id`, `book_manufacturers`.`title`,
				  ...
				  `book_manufacturers`.`skype`, `book_manufacturers`.`status`,
	...
	$cmd->execute();
	$cmd->bind_result($Id, $title, $alias, $description, $content, $logo, $website, $yahoo, $skype, $status, $sticky, $date_add, $order_num);
	if($cmd->fetch()){		
?>
				...
				<tr>
					<td class="key"><label for="title">Nhà sản xuất: <font color="#FF0000">(*)</font></label></td>
					<td colspan="2">
				...
				<tr>
					...
					<td colspan="2">
						...
						Bạn có thể nhập nhiều địa chỉ website theo cú pháp sau: <strong> website1|website2 </strong>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						...
						Bạn có thể nhập nhiều địa chỉ yahoo theo cú pháp sau: <strong> yahoo1|yahoo2 </strong>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						...
						Bạn có thể nhập nhiều địa chỉ skype theo cú pháp sau: <strong> skype1|skype2 </strong>
					</td>
				</tr>
				<tr>
		...
		<input type="hidden" name="hidden" value="submit_com_product_manufacturer_copy" />
		<input type="hidden" name="product_id" value="<?php echo intval($_GET["id"]);?>" />
