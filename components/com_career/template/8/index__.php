...
<head>
	<?php
		include_once("components/com_createcv/template/8/css/app.php");
		include_once("components/com_createcv/template/8/css/viewCV.php");
		include_once("components/com_createcv/template/8/css/print.php");
		include_once("components/com_createcv/template/8/css/bootstrap.min.left.php");
        ...
        <div class="col-sm-12 col-md-12 col-lg-12" data-x-name="parrent" style='padding:0'>
            ...
            <div class="cv_wrap  page">
                ...
                <div class="cv_info clearfix">
                    <div class="avatar clearfix">
                        ...
                        <div class="name">
                            ...
                            <p data-x-id="job" contenteditable="true"><?php echo $row['bangcap1']?></p>
                        </div>
                        <div class="line">&nbsp;</div>
                    </div>
                </div>
				<div class="content_left_right">
                    ...
                    <div class="cv_info" data-x-name="item" data-x-id="info">
                        ...
                        <ul class="info">
                            <li>
                                ...
                                <p data-x-rel="dob"> <img class="ico2" alt=""> <span data-x-id="dob" contenteditable="true"><?php echo $row['birthday'] ?></span> </p>
                                <p data-x-rel="tel"> <img class="ico4" alt=""> <span data-x-id="tel" contenteditable="true"><?php echo $row['mobile'] ?></span> </p>
                                <p data-x-rel="email"> <img class="ico5" alt=""> <span data-x-id="email" contenteditable="true"><?php echo $email ?></span> </p>
                    ...
                    <div data-x-name="group-item"><div class="right_block" data-x-name="item" data-x-id="skill_th">
                            <h2 data-x-id="tit" contenteditable="true" class="ml_ttl">KỸ NĂNG</h2>
                            <ul class="cc_lst" data-x-name="list-item">
								...
								<li data-x-name="sub-item">
                                    <h5 data-x-id="name" contenteditable="true"><?php echo $kynangchuyenmon[$num_] ?></h5>
                                    <p class="cvo-skillrate-bar"><?php
                        ...
                        </div><div class="right_block" data-x-name="item" data-x-id="skill_ta">
                ...
                <div class="col_right" data-x-name="col-parrent" data-x-col="2">
                    ...
                    <div data-x-name="group-item"><div class="block clearfix" data-x-name="item" data-x-id="award">
								...
								<div class="block_content" data-x-name="list-item"> 
									...
									?>
										<div class="block_line clearfix" data-x-name="sub-item">
											<h3 class="clearfix"> <div data-x-id="name" contenteditable="true"> <?php echo $truongkhoahoc[$num_] ?></div></h3>
											 <p class="date"><img class="ico16" alt=""><?php echo $arrBangCap[1] ?> </p>
											<div class="cont_txt clearfix">
												<div data-x-id="cat" contenteditable="true"><?php echo $motachitiet[$num_] ?></div>
												<div data-x-id="des" contenteditable="true" class="normal">Bằng cấp: <?php echo $arrBangCap[0] ?></div>
											</div>
										</div>
									<?php }?>
								</div>
						...
						<div class="block clearfix" data-x-name="item" data-x-id="exp">
                            <div class="blockR">
                                ...
                                <div class="block_content" data-x-name="list-item">
									...
									<div class="block_line block_line2 clearfix" data-x-name="sub-item">
                                        <h3 class="clearfix"><div data-x-id="name" contenteditable="true"><?php echo $congty[$num_] ?></div> </h3>
                            ...
                            <div class="blockR">
                                <h2><img alt="" class="ico11 imgDot"><span data-x-id="tit" contenteditable="true">thành tích nổi bật</span></h2>
                                <div class="block_content" data-x-name="list-item">
