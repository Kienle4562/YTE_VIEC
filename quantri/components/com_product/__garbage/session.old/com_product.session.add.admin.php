<div id="content-box">
		<div class="border">
			...
			<div class="m">
				...
				<div class="header icon-48-sections">Sản phẩm » <small>Chủng loại » </small><small><small>Thêm mới</small></small></div>
		...
		<input type="hidden" name="hidden" value="submit_com_product_session_add" />
