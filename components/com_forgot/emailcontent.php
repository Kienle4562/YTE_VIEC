            ...
            <tr >
                <td>
                    <table class="mainContent" align="center" border="0" cellpadding="0" cellspacing="0" width="528">
						...
						<tr>
							<td>
								<a href="<?php echo $_SERVER['HTTP_HOST'] ?>/forgot.html" style="background-color: #7087A3; font-size: 12px; padding: 10px 15px; color: #fff; text-decoration: none"> ĐẶT MẬT KHẨU MỚI</a>
							</td>
						</tr>
                        </tbody></table>
                </td>
