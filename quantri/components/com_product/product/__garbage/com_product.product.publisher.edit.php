...
Nhà xuất bản: <small><small>[ Thêm mới ]</small></small><br>
</div>
...
$sql = "SELECT `book_publishers`.`Id`, `book_publishers`.`publisher_name`, `book_publishers`.`date_add`, `book_publishers`.`status`
		FROM `book_publishers`WHERE `book_publishers`.`Id` = ?";
...
?>
		<div>
			<fieldset class="adminform">
				...
				<tr>
					...
					<td colspan="2">
						<input class="text_area" name="publisher" id="publisher" value="<?php echo $publisher_name; ?>" size="50" maxlength="255" title="nhà xuất bản" type="text">
					</td>
				</tr>
				<tr>
					<td class="key">
		...
		<input type="hidden" name="hidden" value="submit_com_publisher_edit" />
