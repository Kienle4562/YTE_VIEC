				...
				<table id="cashFlowTable" class="m-datatable__table table-bordered m_datatable">
									...
									<tbody>
										<?php 
											...
											$CountUngtuyen = $myprocess->countUngtuyen($rowcs['congviec_id']);
										?>
										...
										<tr>
											...
											<td>
												<p class="m-badge m-badge--success m-badge--wide"><a onclick="showDialogEdit(this)" data-id="<?php echo $rowcs['congviec_id'] ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#Dialog_CapNhat" ><?php echo $CountUngtuyen ?></a></p>
											</td>
											<td>
