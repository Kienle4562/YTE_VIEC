...
<div class="sitemap-container container m_bottom_20 pv-profile-section-body">
    <div class="clearfix m_xs_bottom_10">
        ...
        <h1 class="sitemap-header text-primary color_green"> <a href="view-cv.html" class="cls-green" ><i class="fa fa-arrow-left" aria-hidden="true"></i></a> CHỌN MẪU MÀ BẠN MUỐN</h1>
            <?php
