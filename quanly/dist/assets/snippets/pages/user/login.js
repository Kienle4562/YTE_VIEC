                ...
                success: function(response, status, xhr, $form) {
                	...
                	setTimeout(function() {
						...
						if(response == 0){
							...
							showErrorMsg(form, 'danger', "Tài khoản người mời đăng ký không tồn tại!!!");
						}else{
							// display signup form
							displaySignInForm();
							showErrorMsg(signInForm, 'success', 'Cảm ơn bạn. Để hoàn thành đăng ký của bạn, vui lòng kiểm tra email của bạn.');
						}
					}, 2000);
                }
            });
