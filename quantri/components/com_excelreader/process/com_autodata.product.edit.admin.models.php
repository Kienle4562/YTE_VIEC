<?php defined( '_VALID_MOS' ) or die( include("404.php") );
	...
	class process 
	{
		...
		function process_editproduct($SPID, $product_name, $alias, $product_image, $attach_info, $price, $discounts, $discount_type, $properties_name, $properties_value, $description, $content, $hot_product, $status, $status_product, $date_add, $account_id, $book_category_id, $author, $quality, $shipping_costs, $origin, $Id, $keyword, $show_comment)
		{
			...
			$result = $this->dbObj->SqlQueryInputResult($sql, array( $SPID, $this->dbObj->fix_quotes_dquotes($product_name), $alias, $product_image, $attach_info, $price, $discounts, $discount_type, $properties_name, $properties_value, $this->txt_htmlspecialchars($description), $this->txt_htmlspecialchars($content), $hot_product, $status, $status_product, $date_add, $account_id, $book_category_id, $author, $quality, $shipping_costs, $origin, $keyword, $show_comment,$Id), $lang);
