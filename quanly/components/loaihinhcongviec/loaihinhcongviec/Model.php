<?php defined( '_VALID_MOS' ) or die( include("404.php") );
	...
	// Khai báo chung
    $com_name = "loaihinhcongviec";
	$title = "LOẠI HÌNH CÔNG VIỆC";
	$mota = "danh sách loại hình công việc";
	$db_name = "mst_loaihinhcongviec";
	$primary_key = "loaihinhcongviec_id";
    ...
    */
    ...
    switch(@$_REQUEST["act"]){
		...
		case "LoadList";
			$column = "tenloaihinhcongviec,";
			$column .= "loaihinhcongviec_id,loaihinhcongviec_id as action_id";
