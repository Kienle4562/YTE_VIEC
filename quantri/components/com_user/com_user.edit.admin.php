                ...
                <div id="element-box">
                    ...
                    <div class="m">
                        ...
                        <form method="post" name="phpForm">
                            ...
                            <div>
                                <fieldset class="adminform">
                                    ...
                                    <?php
                                        ...
                                        $result = $myprocess->dbObj->SqlQueryOutputResult($sql, array($_SESSION['session']['uid']));
                            ...
                            <div class="clr"></div>
                            <INPUT type="hidden" value="<?php echo $Ac_Id ?>" name="userid">
                            <input type="hidden" name="hidden" value="submit_com_user_edit_admin" />
