...
*/
$baseUrl = '/file_upload/' . $_SERVER['SERVER_NAME'] . '/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => '10M',
		'allowedExtensions' => '7z,csv,doc,docx,gz,gzip,ods,odt,pdf,png,ppt,pptx,pxd,rar,rtf,tar,tgz,txt,xls,xlsx,zip,mp3,mp4,flv',
		'deniedExtensions' => '');

$config['ResourceType'][] = Array(
		'name' => 'video',				// Single quotes not allowed
		'url' => $baseUrl . 'video',
		'directory' => $baseDir . 'video',
		'maxSize' => '10M',
		'allowedExtensions' => 'mp3,mp4,flv',
		'deniedExtensions' => '');

$config['ResourceType'][] = Array(
		'name' => 'audio',				// Single quotes not allowed
		'url' => $baseUrl . 'audio',
...
$config['ResourceType'][] = Array(
        'name' => 'product',
        'url' => $baseUrl . 'product',
        'directory' => $baseDir . 'product',
        'maxSize' => '2M',
        'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
        'deniedExtensions' => '');
        
$config['ResourceType'][] = Array(
        'name' => 'flash',                // Single quotes not allowed
        'url' => $baseUrl . 'flash',
        'directory' => $baseDir . 'flash',
        'maxSize' => '10M',
        'allowedExtensions' => 'swf,flv,fla',
        'deniedExtensions' => '');
...
$config['plugin_imageresize']['mediumThumb'] = '180x180';
$config['plugin_imageresize']['largeThumb'] = '250x250';